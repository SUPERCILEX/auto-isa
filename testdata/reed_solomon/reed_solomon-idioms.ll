...
define i32 @"0"(ptr %alpha_to, i64 %0, ptr %arrayidx553.i, i32 %1, ptr %arrayidx575.i, i32 %q.6958.i) {
bb:
  %2 = load i32, ptr %arrayidx575.i, align 4, !tbaa !0
  %add576.i = add nsw i32 %2, %q.6958.i
  %rem581.i = srem i32 %add576.i, %1
  %3 = load i32, ptr %arrayidx553.i, align 4, !tbaa !0
  %sub586.i = add i32 %3, %1
...
define i32 @"1"(ptr %arrayidx514.i, ptr %arrayidx532.i, ptr %err.i, i64 %0, ptr %arrayidx512.i) {
bb:
  ...
  %3 = load i32, ptr %arrayidx514.i, align 4, !tbaa !0
  %xor537.i = xor i32 %3, %2
  store i32 %xor537.i, ptr %arrayidx514.i, align 4, !tbaa !0
  ret i32 %xor537.i
}

define i32 @"2"(ptr %alpha_to, i64 %0, ptr %arrayidx553.i, i32 %1, i32 %rem581.i) {
bb:
...
define i32 @"3"(i32 %0, ptr %arrayidx208.i, ptr %arrayidx212.i) {
bb:
...
define i8 @"4"(ptr %arrayidx45, ptr %arrayidx48) {
bb:
...
define i32 @"5"(i32 %0, ptr %index_of, i64 %1, ptr %arrayidx14.i, i32 %2, ptr %3, i32 %4) {
bb:
...
define i32 @"6"(ptr %arrayidx14.i, i32 %0, ptr %arrayidx30.i) {
bb:
...
define i32 @"8"(ptr %alpha_to, i64 %0, ptr %arrayidx53.i, i32 %1, ptr %arrayidx149.i, ptr %arrayidx156.i) {
bb:
  %2 = load i32, ptr %arrayidx156.i, align 4, !tbaa !0
  %3 = load i32, ptr %arrayidx53.i, align 4, !tbaa !0
  %add154.i = add nsw i32 %3, %1
  %4 = load i32, ptr %arrayidx149.i, align 4, !tbaa !0
  %sub157.i = add i32 %add154.i, %4
  %add162.i = sub i32 %sub157.i, %2
...
define i32 @"9"(ptr %alpha_to, i64 %0, ptr %arrayidx262.i, ptr %arrayidx242.i, i32 %1) {
bb:
  %2 = load i32, ptr %arrayidx262.i, align 4, !tbaa !0
  %3 = load i32, ptr %arrayidx242.i, align 4, !tbaa !0
  %add263.i = add nsw i32 %2, %3
...
define i32 @"10"(ptr %arrayidx15.i, ptr %arrayidx20.i, ptr %arrayidx5.i) {
bb:
  %0 = load i32, ptr %arrayidx20.i, align 4, !tbaa !0
  %1 = load i32, ptr %arrayidx15.i, align 4, !tbaa !0
  %xor.i77 = xor i32 %1, %0
  store i32 %xor.i77, ptr %arrayidx5.i, align 4, !tbaa !0
  ret i32 %xor.i77
}

define i32 @"11"(ptr %0, i32 %mask.059.i) {
bb:
...
define i32 @"12"(ptr %arrayidx20.i, ptr %arrayidx5.i) {
bb:
  %0 = load i32, ptr %arrayidx20.i, align 4, !tbaa !0
...
define i32 @"13"(i32 %0, ptr %index_of, i64 %1, ptr %arrayidx14.i, i32 %2) {
bb:
...
define i32 @"14"(ptr %arrayidx, ptr %arrayidx2) {
bb:
...
define i32 @"15"(i32 %0, ptr %index_of, i64 %1, ptr %2) {
bb:
...
define i32 @"16"(ptr %arrayidx339.i, i32 %0, i32 %1) {
bb:
...
define i32 @"17"(ptr %arrayidx553.i, ptr %err.i, i64 %0, ptr %arrayidx512.i) {
bb:
  %1 = load i32, ptr %arrayidx553.i, align 4, !tbaa !0
  %2 = load i32, ptr %arrayidx512.i, align 4, !tbaa !0
  %idxprom513.i = sext i32 %2 to i64
  %arrayidx514.i = getelementptr inbounds [255 x i32], ptr %err.i, i64 %0, i64 %idxprom513.i
  store i32 %1, ptr %arrayidx514.i, align 4, !tbaa !0
  ret i32 %1
}

define i32 @"18"(ptr %arrayidx.i85, ptr %arrayidx10.i) {
bb:
  %0 = load i32, ptr %arrayidx.i85, align 4, !tbaa !0
  %1 = load i32, ptr %arrayidx10.i, align 4, !tbaa !0
  %xor.i93 = xor i32 %0, %1
  store i32 %xor.i93, ptr %arrayidx.i85, align 4, !tbaa !0
  ret i32 %xor.i93
}

define i32 @"19"(ptr %alpha_to, i64 %0, ptr %arrayidx13.i, i32 %1, i32 %2) {
bb:
...
define i32 @"20"(ptr %arrayidx14.i, i32 %0, ptr %1, i32 %2, ptr %arrayidx30.i) {
bb:
  %3 = load i32, ptr %arrayidx14.i, align 4, !tbaa !0
  %xor20.i = shl i32 %3, %0
...
define i32 @"21"(ptr %index_of, i64 %0, ptr %arrayidx5.i) {
bb:
...
define i32 @"22"(ptr %index_of, i64 %0, ptr %1, ptr %arrayidx5.i65) {
bb:
  %2 = load i32, ptr %arrayidx5.i65, align 4, !tbaa !0
  %3 = load i32, ptr %1, align 4, !tbaa !0
  %xor.i66 = xor i32 %3, %2
...
define i32 @"23"(ptr %arrayidx165.i, ptr %elp.i, i64 %0, i64 %1, i32 %2, ptr %arrayidx100.i, ptr %arrayidx102.i, i32 %indvars.i, i32 %q.1.i, i32 %3) {
bb:
  %4 = load i32, ptr %arrayidx102.i, align 4, !tbaa !0
  %5 = load i32, ptr %arrayidx100.i, align 4, !tbaa !0
  %cmp103.i = icmp slt i32 %5, %4
...
define i32 @"24"(ptr %arrayidx165.i, ptr %arrayidx172.i) {
bb:
...
define i32 @"25"(ptr %index_of, i64 %0, ptr %arrayidx572.i, i32 %1) {
bb:
...
define i32 @"26"(ptr %alpha_to, i64 %0, ptr %arrayidx527.i, i32 %1, ptr %arrayidx521.i, i32 %2) {
bb:
...
define i32 @"27"(ptr %l.i, i64 %0, ptr %arrayidx100.i, ptr %arrayidx102.i, i32 %indvars.i, i32 %q.1.i) {
bb:
  %1 = load i32, ptr %arrayidx102.i, align 4, !tbaa !0
  %2 = load i32, ptr %arrayidx100.i, align 4, !tbaa !0
  %cmp103.i = icmp slt i32 %2, %1
  %spec.select920.i = select i1 %cmp103.i, i32 %indvars.i, i32 %q.1.i
