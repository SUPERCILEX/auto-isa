...
define i32 @"0"(i32 %or218, i32 %or42, ptr %x) {
bb:
...
define i32 @"1"(ptr %ptr, i32 %0, i32 %1) {
bb:
...
define i32 @"2"(ptr %outbuf, i64 %0, ptr %ptr, i32 %1, i32 %2) {
bb:
...
bb:
  %0 = load i32, ptr %arrayidx361, align 4, !tbaa !0
  %1 = load i32, ptr %arrayidx359, align 4, !tbaa !0
  %add362 = add i32 %0, %1
