...
bb:
  %1 = load ptr, ptr %__args, align 8, !tbaa !24
  ...
  store ptr %1, ptr %add.ptr, align 8, !tbaa !24
  ret ptr %1
}
...
bb:
  %1 = load i32, ptr %arrayidx.i36, align 4, !tbaa !22
...
define ptr @"20"(ptr %out_index_.i, i32 %cond, ptr %.omp.lb, i64 %0, i64 %1) {
bb:
  %2 = load i32, ptr %.omp.lb, align 4, !tbaa !22
  %3 = sub i32 %cond, %2
  %4 = zext i32 %3 to i64
  ...
  %7 = load ptr, ptr %out_index_.i, align 8, !tbaa !41
  %arrayidx.i = getelementptr inbounds ptr, ptr %7, i64 %indvars.iv.next
  %8 = load ptr, ptr %arrayidx.i, align 8, !tbaa !15
  ret ptr %8
}

define i64 @"21"(ptr %arrayidx.i140, i64 %0, i64 %1, i64 %2, i64 %3, i64 %xor.i143, i64 %4, i64 %5, i64 %xor4.i146, i64 %6, i64 %xor7.i149, ptr %num_nodes_, i64 %7, ptr %arrayidx.i72, i64 %xor.i75, i64 %xor4.i78, i64 %xor7.i81, i32 %8, ptr %el, ptr %.omp.lb) {
bb:
  %9 = load i64, ptr %arrayidx.i140, align 8, !tbaa !5
  %shr.i141 = lshr i64 %9, %0
  %and.i142 = and i64 %shr.i141, %1
  %xor.i1432 = xor i64 %and.i142, %9
  ...
  %10 = load i64, ptr %num_nodes_, align 8, !tbaa !42
  ...
  %12 = load i64, ptr %arrayidx.i72, align 8, !tbaa !5
...
define <2 x ptr> @"22"(ptr %out_index_.i, i64 %index, ptr %.omp.lb, i64 %0) {
bb:
  %1 = load ptr, ptr %out_index_.i, align 8, !tbaa !41
  %2 = load i32, ptr %.omp.lb, align 4, !tbaa !22
  %3 = sext i32 %2 to i64
  %offset.idx = add i64 %index, %3
  %4 = add nsw i64 %offset.idx, %0
  %5 = getelementptr inbounds ptr, ptr %1, i64 %4
  %wide.load = load <2 x ptr>, ptr %5, align 8, !tbaa !15
  ret <2 x ptr> %wide.load
}

define i32 @"23"(ptr %el, ptr %.omp.lb, i64 %0, i64 %1, i64 %2) {
bb:
  %3 = load i64, ptr %.omp.lb, align 8, !tbaa !5
  %4 = sub i64 %0, %3
  %n.vec = and i64 %4, %1
...
define float @"24"(ptr %init_score, ptr %arrayidx.i.prol, ptr %arrayidx4.i.phi.trans.insert, i64 %0, ptr %outgoing_contrib, i32 %cond, ptr %.omp.lb, i64 %1, i64 %2) {
bb:
  ...
  %arrayidx.i23.prol = getelementptr inbounds float, ptr %3, i64 %ind.end
  %.pre = load ptr, ptr %arrayidx4.i.phi.trans.insert, align 8, !tbaa !15
  %sub.ptr.rhs.cast.i.prol = ptrtoint ptr %.pre to i64
  %9 = load ptr, ptr %arrayidx.i.prol, align 8, !tbaa !15
  %sub.ptr.lhs.cast.i.prol = ptrtoint ptr %9 to i64
  ...
  %10 = load float, ptr %init_score, align 4, !tbaa !7
  %div10.prol = fdiv float %10, %conv9.prol
  store float %div10.prol, ptr %arrayidx.i23.prol, align 4, !tbaa !7
...
define float @"26"(ptr %init_val, ptr %this, ptr %.omp.lb, i64 %0, i64 %1) {
bb:
...
define <4 x float> @"28"(<4 x float> %0, ptr %init_val, i64 %1, ptr %this, ptr %.omp.lb, i64 %index, i64 %2) {
bb:
  %3 = load i64, ptr %.omp.lb, align 8, !tbaa !5
...
define ptr @"35"(ptr %new_range.i.i, ptr %el, i64 %sub.ptr.rhs.cast, i64 %0, ptr %end_size_.i) {
bb:
  %1 = load ptr, ptr %el, align 8, !tbaa !18
  %sub.ptr.lhs.cast = ptrtoint ptr %1 to i64
  %sub.ptr.sub = sub i64 %sub.ptr.lhs.cast, %sub.ptr.rhs.cast
...
define i32 @"36"(ptr %num_nodes_.i, i64 %0, ptr %add.ptr.i.prol) {
bb:
  %1 = load i64, ptr %num_nodes_.i, align 8, !tbaa !9
  %n.vec = and i64 %1, %0
...
define i64 @"37"(i64 %0, ptr %cond.i31, i64 %sub.ptr.lhs.cast.i, ptr %this, i64 %1, i32 %2) {
bb:
...
define <4 x i32> @"39"(ptr %call171, ptr %arrayidx.i542, i64 %0, i64 %total_missing_inv.1659, ptr %arrayidx.i541, i64 %1) {
bb:
  %2 = load i64, ptr %arrayidx.i542, align 8, !tbaa !5
  %3 = add i64 %2, %0
  %.pre717 = load i32, ptr %arrayidx.i541, align 4, !tbaa !22
...
define i32 @"40"(ptr %n_start.0.in, i64 %0) {
bb:
  %n_start.0 = load ptr, ptr %n_start.0.in, align 8, !tbaa !15
...
define ptr @"41"(ptr %new_range.i.i457, ptr %0, ptr %el, i64 %sub.ptr.rhs.cast, i64 %1, ptr %end_size_.i) {
bb:
  %2 = load ptr, ptr %el, align 8, !tbaa !18
  %sub.ptr.lhs.cast = ptrtoint ptr %2 to i64
  %sub.ptr.sub = sub i64 %sub.ptr.lhs.cast, %sub.ptr.rhs.cast
...
define float @"42"(float %0, ptr %num_nodes_.i, ptr %init_score) {
bb:
  %1 = load i64, ptr %num_nodes_.i, align 8, !tbaa !9
  %conv = sitofp i64 %1 to float
  %div = fdiv float %0, %conv
  store float %div, ptr %init_score, align 4, !tbaa !7
  ret float %div
}
...
define i64 @"44"(ptr %arrayidx.i535, i64 %total_missing_inv.0649, ptr %arrayidx.i536, ptr %offsets, i64 %indvars.iv691) {
bb:
...
define i64 @"45"(ptr %arrayidx3.i.i91, i64 %0, ptr %1, i64 %2, i64 %3, ptr %arrayidx7.i.i95, i64 %4, i64 %5, ptr %arrayidx.i.i88) {
bb:
...
define i32 @"46"(ptr %add.ptr.i.i, ptr %__first, ptr %add.ptr.i, ptr %add.ptr2.i, i64 %sub1.i, i64 %mul.i) {
bb:
...
define ptr @"47"(ptr %new_range.i.i, ptr %0, ptr %el, i64 %1, i64 %sub.ptr.rhs.cast, i64 %2, ptr %end_size_.i) {
bb:
  %.pre = load ptr, ptr %el, align 8, !tbaa !18
  %incdec.ptr7.i.i = getelementptr inbounds %struct.EdgePair, ptr %.pre, i64 %1
  %sub.ptr.lhs.cast = ptrtoint ptr %incdec.ptr7.i.i to i64
...
define i32 @"48"(ptr %__first, ptr %add.ptr.i, ptr %add.ptr2.i, i64 %sub1.i, i64 %mul.i, i64 %0, i64 %1) {
bb:
...
define i32 @"49"(ptr %end_size_.i.i583, i64 %sub.ptr.rhs.cast.i.i585, i64 %0, ptr %length.i581) {
bb:
...
define float @"52"(ptr %init_score, ptr %arrayidx.i, ptr %arrayidx.i.1, i64 %0, ptr %outgoing_contrib, i32 %cond, ptr %.omp.lb, i64 %1, i64 %2) {
bb:
  %3 = load ptr, ptr %arrayidx.i.1, align 8, !tbaa !15
  ...
  %5 = load float, ptr %init_score, align 4, !tbaa !7
  %div10 = fdiv float %5, %conv9
  %6 = load ptr, ptr %outgoing_contrib, align 8, !tbaa !0
  %7 = load i32, ptr %.omp.lb, align 4, !tbaa !22
  %8 = sub i32 %cond, %7
  %9 = zext i32 %8 to i64
  ...
  %arrayidx.i23 = getelementptr inbounds float, ptr %6, i64 %ind.end
  store float %div10, ptr %arrayidx.i23, align 4, !tbaa !7
  ret float %div10
}

define i8 @"53"(ptr %arrayidx.i17.i, ptr %ref.tmp, i64 %conv5.i, i64 %idxprom1.i.i) {
bb:
...
define i64 @"54"(ptr %new_range.i.i, i64 %0, i64 %1) {
bb:
  %2 = load ptr, ptr %new_range.i.i, align 8, !tbaa !15
  %incdec.ptr13.i.i.i.i = getelementptr inbounds %struct.EdgePair, ptr %2, i64 %0
...
define float @"55"(ptr %arrayidx.i, ptr %arrayidx.i124, i64 %sub.ptr.rhs.cast.i, i64 %0, ptr %arrayidx.i132, ptr %incoming_sums, ptr %__begin2.0160) {
bb:
  %1 = load ptr, ptr %incoming_sums, align 8
  %2 = load i32, ptr %__begin2.0160, align 4, !tbaa !22
  %conv28 = sext i32 %2 to i64
  %arrayidx.i1322 = getelementptr inbounds float, ptr %1, i64 %conv28
  %3 = load float, ptr %arrayidx.i132, align 4, !tbaa !7
  %4 = load float, ptr %arrayidx.i, align 4, !tbaa !7
  %5 = load ptr, ptr %arrayidx.i124, align 8, !tbaa !15
...
define <2 x float> @"56"(<2 x float> %0, ptr %init_score, i64 %1, ptr %2, <2 x ptr> %vector.recur, <2 x i64> %3, ptr %outgoing_contrib, i64 %index, ptr %.omp.lb) {
bb:
  %4 = load i32, ptr %.omp.lb, align 4, !tbaa !22
  %5 = sext i32 %4 to i64
  %offset.idx = add i64 %index, %5
  %6 = load ptr, ptr %outgoing_contrib, align 8, !tbaa !0
  %7 = getelementptr inbounds float, ptr %6, i64 %offset.idx
  %wide.load = load <2 x ptr>, ptr %2, align 8, !tbaa !15
  ...
  %14 = load float, ptr %init_score, align 4, !tbaa !7, !alias.scope !63
  ...
  store <2 x float> %15, ptr %7, align 4, !tbaa !7, !alias.scope !66, !noalias !63
  ret <2 x float> %15
}

define i64 @"57"(ptr %new_range.i.i, i64 %0) {
bb:
...
define ptr @"58"(ptr %el, i64 %0, i64 %sub.ptr.rhs.cast, i64 %1, ptr %end_size_.i) {
bb:
  %.pre = load ptr, ptr %el, align 8, !tbaa !18
  %incdec.ptr7.i.i = getelementptr inbounds %struct.EdgePair, ptr %.pre, i64 %0
  %sub.ptr.lhs.cast = ptrtoint ptr %incdec.ptr7.i.i to i64
...
define i32 @"59"(ptr %arrayidx212, ptr %call171, i64 %tail_index.0660, ptr %arrayidx.i542, ptr %arrayidx.i540, ptr %arrayidx.i541, i64 %0) {
bb:
...
define i8 @"60"(ptr %label) {
bb:
  %0 = load ptr, ptr %label, align 8, !tbaa !24, !noalias !68
...
define i64 @"62"(ptr %arrayidx.i, ptr %prefix, ptr %.omp.lb, i64 %0) {
bb:
  ...
  %mul14 = shl i64 %3, %0
  %arrayidx.i35 = getelementptr inbounds i64, ptr %2, i64 %mul14
  store i64 %1, ptr %arrayidx.i35, align 8, !tbaa !5
  ret i64 %1
}

define ptr @"63"(ptr %new_range.i.i, ptr %el, i64 %0, ptr %end_capacity_.i.i.i) {
bb:
  %1 = load ptr, ptr %el, align 8, !tbaa !18
...
define float @"64"(ptr %init_score, ptr %arrayidx.i.prol, ptr %0, i64 %1, i64 %2, ptr %outgoing_contrib, i32 %cond, ptr %.omp.lb, i64 %3) {
bb:
  ...
  %arrayidx.i23.prol = getelementptr inbounds float, ptr %4, i64 %ind.end
  %wide.load = load <2 x ptr>, ptr %0, align 8, !tbaa !15
  ...
  %10 = load ptr, ptr %arrayidx.i.prol, align 8, !tbaa !15
  %sub.ptr.lhs.cast.i.prol = ptrtoint ptr %10 to i64
  %sub.ptr.sub.i.prol = sub i64 %sub.ptr.lhs.cast.i.prol, %sub.ptr.rhs.cast.i.prol
  %sub.ptr.div.i.prol = ashr exact i64 %sub.ptr.sub.i.prol, %2
  %conv9.prol = sitofp i64 %sub.ptr.div.i.prol to float
  %11 = load float, ptr %init_score, align 4, !tbaa !7
  %div10.prol = fdiv float %11, %conv9.prol
  store float %div10.prol, ptr %arrayidx.i23.prol, align 4, !tbaa !7
  ret float %div10.prol
}

define i32 @"65"(ptr %__first, ptr %add.ptr.i.i.i, ptr %add.ptr2.i.i.i, ptr %v.i.i.i.i.i, ptr %v3.i.i.i.i.i, i64 %sub1.i.i.i, i64 %mul.i.i.i, i64 %0, i64 %1) {
bb:
...
define i64 @"66"(ptr %rng, i64 %0, ptr %arrayidx42.i.i124, i64 %1, i64 %2, ptr %arrayidx49.i.i128, i64 %3, i64 %4) {
bb:
  %5 = load i64, ptr %arrayidx49.i.i128, align 8, !tbaa !5
  %6 = load i64, ptr %rng, align 8, !tbaa !5
...
define ptr @"68"(ptr %new_range.i.i, ptr %el, i64 %0, i64 %1, ptr %end_capacity_.i.i.i) {
bb:
  %2 = load ptr, ptr %el, align 8, !tbaa !18
...
define ptr @"69"(ptr %call.i, ptr %end_size_.i, ptr %degrees, i64 %0, i64 %1, i64 %2, ptr %end_size_.i40) {
bb:
...
define i64 @"70"(ptr %_M_p.i.i.i, i64 %0) {
bb:
  %1 = load i64, ptr %_M_p.i.i.i, align 8, !tbaa !71
  %inc.i71 = add nuw nsw i64 %1, %0
  %inc.i207 = add nuw nsw i64 %inc.i71, %0
  %inc.i139 = add nuw nsw i64 %inc.i207, %0
  store i64 %inc.i139, ptr %_M_p.i.i.i, align 8, !tbaa !71
  ret i64 %inc.i139
}

define i64 @"71"(ptr %add.ptr.i.i.i.i16, ptr %__first, ptr %add.ptr.i.i.i, ptr %add.ptr2.i.i.i, ptr %v.i.i.i.i.i, ptr %v3.i.i.i.i.i, i64 %sub1.i.i.i, i64 %mul.i.i.i) {
bb:
...
define ptr @"72"(ptr %index.i139, ptr %0) {
bb:
...
define i64 @"73"(ptr %arrayidx.i58.epil, i64 %total.076.epil, ptr %call.i4145, ptr %num_blocks) {
bb:
...
define i64 @"74"(ptr %_M_string_length.i.i.i, i64 %call, ptr %__dnew.i.i.i) {
bb:
  %0 = load i64, ptr %_M_string_length.i.i.i, align 8, !tbaa !55, !noalias !73
  %sub.i.i.i = sub i64 %0, %call
  store i64 %sub.i.i.i, ptr %__dnew.i.i.i, align 8, !tbaa !5, !noalias !73
  ret i64 %sub.i.i.i
}

define i64 @"75"(ptr %arrayidx.i27, i64 %0, ptr %arrayidx.i25, ptr %el, ptr %.omp.lb) {
bb:
  %1 = load i64, ptr %.omp.lb, align 8, !tbaa !5
  %2 = load ptr, ptr %el, align 8, !tbaa !18
...
define i32 @"76"(ptr %call171, ptr %0, ptr %arrayidx.i546) {
bb:
  %1 = load i32, ptr %arrayidx.i546, align 4, !tbaa !22
  %conv246 = sext i32 %1 to i64
  %.pre718 = load i64, ptr %0, align 8, !tbaa !5
...
define ptr @"77"(ptr %transpose, i8 %0, ptr %out_index_.i, ptr %in_index_.i, ptr %.omp.lb, i64 %1) {
bb:
  %2 = load i32, ptr %.omp.lb, align 4, !tbaa !22
  %3 = sext i32 %2 to i64
  %4 = add nsw i64 %3, %1
  %5 = load i8, ptr %transpose, align 1, !tbaa !76, !range !77, !noundef !78
...
define i32 @"78"(ptr %n_start.0.in, i64 %0, i64 %1, ptr %diffs, ptr %.omp.lb) {
bb:
  %n_start.0 = load ptr, ptr %n_start.0.in, align 8, !tbaa !15
  %incdec.ptr12.i.i.i.i = getelementptr inbounds i32, ptr %n_start.0, i64 %0
...
define i64 @"79"(ptr %offsets, ptr %.omp.lb) {
bb:
...
define <2 x i64> @"80"(ptr %0, ptr %offsets, ptr %num_nodes_.i, i64 %1, i64 %index770, i64 %2) {
bb:
  %wide.load = load <2 x i64>, ptr %0, align 8, !tbaa !5
  %3 = load ptr, ptr %offsets, align 8
  %4 = load i64, ptr %num_nodes_.i, align 8, !tbaa !79
  %5 = and i64 %4, %1
...
define i64 @"81"(ptr %offsets, ptr %num_nodes_.i) {
bb:
  %.pre716.pre = load ptr, ptr %offsets, align 8, !tbaa !44
  %0 = load i64, ptr %num_nodes_.i, align 8, !tbaa !79
  %arrayidx.i533 = getelementptr inbounds i64, ptr %.pre716.pre, i64 %0
  %1 = load i64, ptr %arrayidx.i533, align 8, !tbaa !5
  ret i64 %1
}

define i64 @"82"(ptr %offsets, ptr %num_nodes_.i, i64 %0) {
bb:
  %1 = load i64, ptr %num_nodes_.i, align 8, !tbaa !79
  %sext = shl i64 %1, %0
...
define ptr @"85"(ptr %cond.i31.i.i.i, ptr %_M_finish.i38, i64 %0, i64 %1, i64 %2, i64 %3, i64 %4) {
bb:
  %5 = load ptr, ptr %_M_finish.i38, align 8, !tbaa !81
  ...
  store ptr %incdec.ptr.i.i.i, ptr %_M_finish.i38, align 8, !tbaa !81
  ret ptr %incdec.ptr.i.i.i
}

define i64 @"86"(ptr %v, i32 %0, i64 %1, i64 %agg.tmp93.sroa.0.0.insert.ext, ptr %end_size_.i.i) {
bb:
...
define ptr @"87"(ptr %new_range.i.i, ptr %end_size_.i.i, ptr %agg.result, i64 %0) {
bb:
  %1 = load ptr, ptr %new_range.i.i, align 8, !tbaa !15
...
define i32 @"89"(ptr %__first, ptr %add.ptr.i.i.i.i, ptr %add.ptr2.i.i.i.i, ptr %v.i.i.i.i.i.i, ptr %v3.i.i.i.i.i.i, i64 %sub1.i.i.i.i, i64 %mul.i.i.i.i, i64 %0, i64 %1) {
bb:
...
define float @"90"(ptr %arrayidx.i, ptr %call5.i.i.i.i4.i.i45, ptr %num_nodes_.i, i64 %0, i32 %1) {
bb:
...
define i64 @"91"(ptr %arrayidx.i58.3, ptr %arrayidx.i58.2, ptr %arrayidx.i58.1, ptr %arrayidx.i58, i64 %total.076, ptr %arrayidx.i57.epil) {
bb:
  %0 = load i64, ptr %arrayidx.i58, align 8, !tbaa !5
  %add7 = add nsw i64 %0, %total.076
  %1 = load i64, ptr %arrayidx.i58.1, align 8, !tbaa !5
...
define i32 @"92"(ptr %call171, ptr %arrayidx.i548, ptr %arrayidx.i549, ptr %arrayidx.i550, i64 %sub.ptr.rhs.cast.i.i.i.i552, i64 %0, i64 %1) {
bb:
...
define <2 x float> @"93"(<2 x float> %0, ptr %init_score, i64 %1, ptr %2, <2 x ptr> %3, ptr %arrayidx4.i.phi.trans.insert, i64 %4, <2 x i64> %5, ptr %outgoing_contrib, i64 %index, ptr %.omp.lb) {
bb:
  %6 = load i32, ptr %.omp.lb, align 4, !tbaa !22
  %7 = sext i32 %6 to i64
  %offset.idx = add i64 %index, %7
  %8 = load ptr, ptr %outgoing_contrib, align 8, !tbaa !0
  %9 = getelementptr inbounds float, ptr %8, i64 %offset.idx
  %wide.load = load <2 x ptr>, ptr %2, align 8, !tbaa !15
  %.pre = load ptr, ptr %arrayidx4.i.phi.trans.insert, align 8, !tbaa !15
  %vector.recur.init = insertelement <2 x ptr> %3, ptr %.pre, i64 %4
  %10 = shufflevector <2 x ptr> %vector.recur.init, <2 x ptr> %wide.load, <2 x i32> <i32 1, i32 2>
  %11 = ptrtoint <2 x ptr> %10 to <2 x i64>
  %12 = ptrtoint <2 x ptr> %wide.load to <2 x i64>
  %13 = sub <2 x i64> %12, %11
  %14 = ashr exact <2 x i64> %13, %5
  %15 = sitofp <2 x i64> %14 to <2 x float>
  %16 = load float, ptr %init_score, align 4, !tbaa !7, !alias.scope !63
  %broadcast.splatinsert = insertelement <2 x float> %0, float %16, i64 %1
  %broadcast.splat = shufflevector <2 x float> %broadcast.splatinsert, <2 x float> %0, <2 x i32> zeroinitializer
  %17 = fdiv <2 x float> %broadcast.splat, %15
  store <2 x float> %17, ptr %9, align 4, !tbaa !7, !alias.scope !66, !noalias !63
  ret <2 x float> %17
}

define <2 x i64> @"94"(ptr %0, <2 x i64> %1, <2 x i64> %2, ptr %rng, i64 %3, <2 x i64> %4, <2 x i64> %5, ptr %6, <2 x i64> %7, <2 x i64> %8, ptr %9) {
bb:
...
define float @"95"(ptr %init_score, ptr %arrayidx.i, ptr %0, i64 %1, i64 %2, ptr %outgoing_contrib, i32 %cond, ptr %.omp.lb, i64 %3) {
bb:
  %wide.load = load <2 x ptr>, ptr %0, align 8, !tbaa !15
  %vector.recur.extract = extractelement <2 x ptr> %wide.load, i64 %1
...
define i64 @"96"(ptr %rng, i64 %0, ptr %_M_p.i.i.i, i64 %1) {
bb:
  %2 = load i64, ptr %_M_p.i.i.i, align 8, !tbaa !71
...
define ptr @"97"(ptr %new_range.i.i, ptr %end_capacity_.i.i, ptr %agg.result, i64 %0) {
bb:
  %1 = load ptr, ptr %new_range.i.i, align 8, !tbaa !15
  %2 = load ptr, ptr %agg.result, align 8, !tbaa !18
  %sub.ptr.rhs.cast.i.i = ptrtoint ptr %2 to i64
  %3 = load ptr, ptr %end_capacity_.i.i, align 8, !tbaa !23
...
define i64 @"98"(ptr %arrayidx.i, i64 %0, ptr %offsets, ptr %__begin0.0640) {
bb:
...
define i64 @"99"(i32 %shl19, ptr %arrayidx.i61, i64 %0, i64 %1, i64 %2, i64 %3, i64 %xor.i63, i64 %4, i64 %5, i64 %xor4.i, i64 %6, i64 %xor7.i, i32 %7, i32 %8, i32 %9, i32 %conv, i64 %10, i64 %ref.tmp30.sroa.0.0.insert.ext, ptr %el, ptr %.omp.lb) {
bb:
...
define ptr @"100"(ptr %new_range.i.i, ptr %0, ptr %el, i64 %sub.ptr.rhs.cast, i64 %1, ptr %end_size_.i) {
bb:
  %2 = load ptr, ptr %el, align 8, !tbaa !18
  %sub.ptr.lhs.cast = ptrtoint ptr %2 to i64
  %sub.ptr.sub = sub i64 %sub.ptr.lhs.cast, %sub.ptr.rhs.cast
...
define ptr @"101"(ptr %el, ptr %0, i64 %sub.ptr.rhs.cast, i64 %1, ptr %end_size_.i) {
bb:
  %2 = load ptr, ptr %el, align 8, !tbaa !18
  %sub.ptr.lhs.cast = ptrtoint ptr %2 to i64
  %sub.ptr.sub = sub i64 %sub.ptr.lhs.cast, %sub.ptr.rhs.cast
...
define i64 @"102"(i64 %lsum.036, ptr %arrayidx.i32, ptr %local_sums, ptr %.omp.lb) {
bb:
...
define i32 @"103"(ptr %arrayidx212, ptr %call171, ptr %arrayidx.i539, i64 %0) {
bb:
...
define float @"104"(ptr %_M_finish.i38, i64 %0, i64 %1) {
bb:
  %2 = load ptr, ptr %_M_finish.i38, align 8, !tbaa !81
...
bb:
  %3 = load ptr, ptr %arrayidx.i.i, align 8, !tbaa !15, !noalias !83
  %sub.ptr.lhs.cast.i.i = ptrtoint ptr %3 to i64
  %4 = load ptr, ptr %0, align 8, !tbaa !15, !noalias !83
...
bb:
  %1 = load ptr, ptr %ref.tmp, align 8, !tbaa !24, !alias.scope !68
  %2 = load i64, ptr %__dnew.i.i.i, align 8, !tbaa !5, !noalias !68
...
define i32 @"108"(ptr %neighs, ptr %arrayidx.i523, ptr %arrayidx.i524, i64 %sub.ptr.rhs.cast.i.i.i.i526, i64 %0, i64 %1) {
bb:
...
define float @"109"(float %0, ptr %arrayidx.i71, ptr %arrayidx4.i, i64 %1, ptr %outgoing_contrib, i64 %indvars.iv) {
bb:
  %2 = load ptr, ptr %outgoing_contrib, align 8
  %arrayidx.i72 = getelementptr inbounds float, ptr %2, i64 %indvars.iv
  %3 = load ptr, ptr %arrayidx.i71, align 8, !tbaa !15, !llvm.access.group !33
  %sub.ptr.lhs.cast.i = ptrtoint ptr %3 to i64
  %4 = load ptr, ptr %arrayidx4.i, align 8, !tbaa !15, !llvm.access.group !33
  %sub.ptr.rhs.cast.i = ptrtoint ptr %4 to i64
  %sub.ptr.sub.i = sub i64 %sub.ptr.lhs.cast.i, %sub.ptr.rhs.cast.i
  %sub.ptr.div.i = ashr exact i64 %sub.ptr.sub.i, %1
  %conv37 = sitofp i64 %sub.ptr.div.i to float
  %div38 = fdiv float %0, %conv37
  store float %div38, ptr %arrayidx.i72, align 4, !tbaa !7, !llvm.access.group !33
  ret float %div38
}

define i32 @"110"(ptr %.sroa_idx.phi.trans.insert.i, ptr %second.i.i.i.i.i) {
bb:
  %.pre43.i = load i32, ptr %.sroa_idx.phi.trans.insert.i, align 4
  store i32 %.pre43.i, ptr %second.i.i.i.i.i, align 4, !tbaa !86
  ret i32 %.pre43.i
}

define i32 @"111"(ptr %el, ptr %.omp.lb, i64 %0, i64 %1) {
bb:
...
define i32 @"112"(ptr %arrayidx.i.i.i60, ptr %n_start.0.in, i64 %0, ptr %diffs, ptr %.omp.lb) {
bb:
  %n_end.0 = load ptr, ptr %arrayidx.i.i.i60, align 8, !tbaa !15
...
define <4 x float> @"113"(<2 x float> %0, ptr %1, ptr %2) {
bb:
  %wide.load = load <2 x float>, ptr %1, align 4, !tbaa !7, !alias.scope !87
...
define i32 @"114"(ptr %incdec.ptr.i, i64 %0, ptr %second3.i29.i.i.i) {
bb:
  %__value.sroa.0.0.copyload.i = load i64, ptr %incdec.ptr.i, align 4
  ...
  store i32 %__value.sroa.3.0.extract.trunc.i.i.i, ptr %second3.i29.i.i.i, align 4, !tbaa !86
  ret i32 %__value.sroa.3.0.extract.trunc.i.i.i
}

define i32 @"115"(ptr %el, i64 %0, i64 %1, i32 %2) {
bb:
  %.pre = load ptr, ptr %el, align 8, !tbaa !18
  %incdec.ptr122.i.i = getelementptr inbounds %struct.EdgePair, ptr %.pre, i64 %0
...
define i64 @"116"(ptr %arrayidx.i492, ptr %offsets, ptr %num_nodes_.i, i64 %0) {
bb:
  %1 = load i64, ptr %num_nodes_.i, align 8, !tbaa !79
...
define i32 @"117"(ptr %num_nodes_.i, i32 %0, ptr %.omp.ub) {
bb:
  %1 = load i64, ptr %num_nodes_.i, align 8, !tbaa !9
...
define i32 @"118"(ptr %arrayidx.i7.i.i.phi.trans.insert) {
bb:
  %.pre = load ptr, ptr %arrayidx.i7.i.i.phi.trans.insert, align 8, !tbaa !15
  %0 = load i32, ptr %.pre, align 4, !tbaa !22, !llvm.access.group !33
  ret i32 %0
}

define i64 @"119"(ptr %arrayidx.i533, i64 %total_missing_inv.0649, ptr %arrayidx.i536, ptr %offsets, ptr %num_nodes_.i) {
bb:
  %.pre716.pre = load ptr, ptr %offsets, align 8, !tbaa !44
  %0 = load i64, ptr %num_nodes_.i, align 8, !tbaa !79
...
define float @"120"(float %0, ptr %scores, ptr %.omp.lb) {
bb:
  %1 = load i32, ptr %.omp.lb, align 4, !tbaa !22
  %2 = sext i32 %1 to i64
  %3 = load ptr, ptr %scores, align 8, !tbaa !0, !llvm.access.group !33
  %arrayidx.i65 = getelementptr inbounds float, ptr %3, i64 %2
  store float %0, ptr %arrayidx.i65, align 4, !tbaa !7, !llvm.access.group !33
  ret float %0
}

define i32 @"121"(ptr %call171, ptr %arrayidx.i542, i64 %0, i64 %total_missing_inv.1659, ptr %arrayidx.i541) {
bb:
  %.pre717 = load i32, ptr %arrayidx.i541, align 4, !tbaa !22
  %.pre731 = sext i32 %.pre717 to i64
  %sub222 = sub nsw i64 %total_missing_inv.1659, %.pre731
...
define i32 @"122"(ptr %n_start.0.in, i64 %0, i64 %1) {
bb:
  %n_start.0 = load ptr, ptr %n_start.0.in, align 8, !tbaa !15
  %incdec.ptr12.i.i.i.i = getelementptr inbounds i32, ptr %n_start.0, i64 %0
...
define i64 @"123"(ptr %.omp.lb, i64 %0, i64 %1, i64 %2, i64 %3, i64 %4, i64 %__i.018.i, i64 %add.i, i64 %inc.i, ptr %arrayidx7.i.1) {
bb:
  %5 = load i64, ptr %.omp.lb, align 8, !tbaa !5
  %add10 = add i64 %5, %0
  %rem.i.i.i = and i64 %add10, %1
...
define i32 @"124"(ptr %degrees, i64 %mul12, i64 %umin, ptr %.omp.lb, i64 %indvar, i64 %0, i64 %n.mod.vf) {
bb:
  %1 = load i64, ptr %.omp.lb, align 8, !tbaa !5
  %2 = add i64 %1, %indvar
  %3 = shl i64 %2, %0
...
define i64 @"127"(ptr %arrayidx.i27, i64 %0, ptr %arrayidx.i25, ptr %el, i64 %.omp.iv.030) {
bb:
  %1 = load ptr, ptr %el, align 8, !tbaa !18
...
define <2 x float> @"128"(<2 x float> %0, ptr %init_score, i64 %1, ptr %2, <2 x i64> %3, ptr %outgoing_contrib, i64 %index, ptr %.omp.lb) {
bb:
  %4 = load i32, ptr %.omp.lb, align 4, !tbaa !22
  %5 = sext i32 %4 to i64
  %offset.idx = add i64 %index, %5
  ...
  %7 = getelementptr inbounds float, ptr %6, i64 %offset.idx
  %wide.load = load <2 x ptr>, ptr %2, align 8, !tbaa !15
  %8 = shufflevector <2 x ptr> %wide.load, <2 x ptr> %wide.load, <2 x i32> <i32 1, i32 2>
...
bb:
  ...
  store ptr %3, ptr %__first.addr.07.i.i.i.i, align 8, !tbaa !24, !alias.scope !90, !noalias !93
  ret ptr %3
}
...
bb:
  ...
  %11 = shl i64 %n.vec, %3
  %ind.end = getelementptr i8, ptr %cond.i31.i.i.i, i64 %11
  %12 = load i64, ptr %__first.addr.07.i.i.i.i.i.i.i, align 4, !alias.scope !95, !noalias !98
  store i64 %12, ptr %ind.end, align 4, !alias.scope !98, !noalias !95
  ret i64 %12
}
...
bb:
  ...
  %inc.i71 = add nuw nsw i64 %1, %0
  %inc.i207 = add nuw nsw i64 %inc.i71, %0
  store i64 %inc.i207, ptr %_M_p.i.i.i, align 8, !tbaa !71
  ret i64 %inc.i207
}

define float @"144"(ptr %init_score, ptr %arrayidx.i.1, ptr %arrayidx.i, i64 %0, ptr %outgoing_contrib, i64 %indvars.iv.next) {
bb:
  %1 = load ptr, ptr %outgoing_contrib, align 8, !tbaa !0
  %arrayidx.i23.1 = getelementptr inbounds float, ptr %1, i64 %indvars.iv.next
  %2 = load float, ptr %init_score, align 4, !tbaa !7
  %3 = load ptr, ptr %arrayidx.i.1, align 8, !tbaa !15
  %sub.ptr.lhs.cast.i.1 = ptrtoint ptr %3 to i64
  %4 = load ptr, ptr %arrayidx.i, align 8, !tbaa !15
  ...
  %div10.1 = fdiv float %2, %conv9.1
  store float %div10.1, ptr %arrayidx.i23.1, align 4, !tbaa !7
  ret float %div10.1
}

define <4 x float> @"145"(<4 x float> %0, ptr %init_val, i64 %1, ptr %this, ptr %.omp.lb, i64 %index) {
bb:
  %2 = load float, ptr %init_val, align 4, !tbaa !7, !alias.scope !47
  ...
  %4 = load ptr, ptr %this, align 8, !tbaa !0
  %5 = getelementptr inbounds float, ptr %4, i64 %offset.idx
  store <4 x float> %broadcast.splat22, ptr %5, align 4, !tbaa !7, !alias.scope !50, !noalias !47
  ret <4 x float> %broadcast.splat22
}
...
bb:
  %3 = load ptr, ptr %_M_finish.i38, align 8, !tbaa !81
...
define float @"151"(ptr %init_score, ptr %arrayidx.i.prol, i64 %sub.ptr.rhs.cast.i.prol, i64 %0, ptr %outgoing_contrib, i64 %indvars.iv.ph) {
bb:
  %1 = load ptr, ptr %outgoing_contrib, align 8, !tbaa !0
  %arrayidx.i23.prol = getelementptr inbounds float, ptr %1, i64 %indvars.iv.ph
  %2 = load float, ptr %init_score, align 4, !tbaa !7
  %3 = load ptr, ptr %arrayidx.i.prol, align 8, !tbaa !15
  %sub.ptr.lhs.cast.i.prol = ptrtoint ptr %3 to i64
  %sub.ptr.sub.i.prol = sub i64 %sub.ptr.lhs.cast.i.prol, %sub.ptr.rhs.cast.i.prol
  %sub.ptr.div.i.prol = ashr exact i64 %sub.ptr.sub.i.prol, %0
  %conv9.prol = sitofp i64 %sub.ptr.div.i.prol to float
  %div10.prol = fdiv float %2, %conv9.prol
  store float %div10.prol, ptr %arrayidx.i23.prol, align 4, !tbaa !7
  ret float %div10.prol
}
...
bb:
  %2 = load i64, ptr %num_nodes_.i, align 8, !tbaa !79
  %3 = and i64 %2, %0
...
bb:
  %1 = load i32, ptr %max_iters_, align 4, !tbaa !100
  %__val.lobit.i = lshr i32 %1, %0
  %conv5.i = zext i32 %__val.lobit.i to i64
  %2 = load ptr, ptr %agg.tmp11, align 8, !tbaa !24, !alias.scope !108
  %arrayidx.i.i = getelementptr inbounds i8, ptr %2, i64 %conv5.i
  %arrayidx2.i.i = getelementptr inbounds i8, ptr %arrayidx.i.i, i64 %idxprom1.i.i
  %3 = load i8, ptr %arrayidx.i17.i, align 1, !tbaa !59, !noalias !108
...
bb:
  ...
  %2 = load ptr, ptr %offsets, align 8
  %3 = load i64, ptr %num_nodes_.i, align 8, !tbaa !79
...
bb:
  %3 = load ptr, ptr %0, align 8, !tbaa !15, !noalias !83
  %sub.ptr.rhs.cast.i20.i = ptrtoint ptr %3 to i64
  %4 = load ptr, ptr %arrayidx.i18.i, align 8, !tbaa !15, !noalias !83
...
define float @"162"(ptr %scores, ptr %.omp.lb) {
bb:
  ...
  %3 = load float, ptr %arrayidx.i65, align 4, !tbaa !7, !llvm.access.group !33
  ret float %3
}

define ptr @"163"(ptr %out_index_.i, ptr %.omp.lb) {
bb:
...
bb:
  ...
  store i64 %inc.i64, ptr %_M_p.i.i.i, align 8, !tbaa !71
  ret i64 %inc.i64
}

define <2 x i64> @"171"(ptr %0, <2 x i64> %1, <2 x i64> %vector.recur90, <2 x i64> %2, <2 x i64> %3, ptr %4, <2 x i64> %5, <2 x i64> %6, ptr %7) {
bb:
  %wide.load91 = load <2 x i64>, ptr %0, align 8, !tbaa !5
...
define <2 x i64> @"172"(ptr %0, <2 x i64> %1, <2 x i64> %2, ptr %.omp.lb, i64 %3, i64 %4, i64 %5, <2 x i64> %6, <2 x i64> %7, ptr %8, <2 x i64> %9, <2 x i64> %10, ptr %11) {
bb:
  %wide.load91 = load <2 x i64>, ptr %0, align 8, !tbaa !5
...
define i64 @"173"(ptr %__first.addr.033.i.i, ptr %new_range.i.i, i64 %0) {
bb:
  %agg.tmp.sroa.0.0.copyload.i.i.i = load i64, ptr %__first.addr.033.i.i, align 4
  %1 = load ptr, ptr %new_range.i.i, align 8, !tbaa !15
  %incdec.ptr13.i.i.i.i = getelementptr inbounds %struct.EdgePair, ptr %1, i64 %0
...
define i8 @"174"(i8 %storemerge.i.i, ptr %agg.tmp11, ptr %max_iters_, i32 %0) {
bb:
  %1 = load ptr, ptr %agg.tmp11, align 8, !tbaa !24, !alias.scope !108
  %2 = load i32, ptr %max_iters_, align 4, !tbaa !100
...
define i64 @"175"(ptr %num_edges_, i64 %0, i64 %1, i64 %2, ptr %.omp.ub) {
bb:
  %3 = load i64, ptr %num_edges_, align 8, !tbaa !113
...
define ptr @"176"(ptr %call.i134135, ptr %num_nodes, i64 %0, ptr %end_size_.i) {
bb:
...
define i64 @"177"(ptr %offsets, ptr %.omp.lb, i64 %0) {
bb:
  %1 = load i32, ptr %.omp.lb, align 4, !tbaa !22
  %2 = sext i32 %1 to i64
...
define i64 @"178"(ptr %arrayidx.i58.epil, i64 %total.076.epil, ptr %arrayidx.i57.epil) {
bb:
...
define i64 @"180"(ptr %max_seen.i, i32 %0, ptr %num_nodes_) {
bb:
  %1 = load i32, ptr %max_seen.i, align 4, !tbaa !22
  %add = add nsw i32 %1, %0
  %conv = sext i32 %add to i64
  store i64 %conv, ptr %num_nodes_, align 8, !tbaa !79
  ret i64 %conv
}

define i32 @"181"(ptr %num_nodes_.i, i64 %0, i64 %1, ptr %add.ptr.i.1) {
bb:
  %2 = load i64, ptr %num_nodes_.i, align 8, !tbaa !9
  %n.vec = and i64 %2, %0
  %indvars.iv.next = add nuw nsw i64 %n.vec, %1
...
define i32 @"182"(ptr %__first.addr.033.i.i, ptr %n_start.0.in, i64 %0) {
bb:
  %n_start.0 = load ptr, ptr %n_start.0.in, align 8, !tbaa !15
  %incdec.ptr12.i.i.i.i = getelementptr inbounds i32, ptr %n_start.0, i64 %0
...
define i32 @"183"(ptr %end_size_.i, ptr %offsets, i64 %0, ptr %length.i138) {
bb:
  %1 = load ptr, ptr %offsets, align 8, !tbaa !44
...
define float @"184"(ptr %arrayidx.i, ptr %arrayidx.i124, i64 %0, ptr %arrayidx.i132, ptr %incoming_sums, ptr %__begin2.0160) {
bb:
  %1 = load ptr, ptr %incoming_sums, align 8
  %2 = load i32, ptr %__begin2.0160, align 4, !tbaa !22
  %conv28 = sext i32 %2 to i64
  %arrayidx.i1322 = getelementptr inbounds float, ptr %1, i64 %conv28
  %3 = load float, ptr %arrayidx.i132, align 4, !tbaa !7
  %4 = load ptr, ptr %arrayidx.i124, align 8, !tbaa !15
  %sub.ptr.rhs.cast.i = ptrtoint ptr %4 to i64
  %sub.ptr.lhs.cast.i = ptrtoint ptr %4 to i64
  %sub.ptr.sub.i = sub i64 %sub.ptr.lhs.cast.i, %sub.ptr.rhs.cast.i
  %sub.ptr.div.i = ashr exact i64 %sub.ptr.sub.i, %0
  ...
  %div19 = fdiv float %5, %conv18
  %add = fadd float %div19, %3
  store float %add, ptr %arrayidx.i132, align 4, !tbaa !7
  ret float %add
}

define float @"185"(ptr %init_val, ptr %this, ptr %.omp.lb, i64 %0) {
bb:
  %1 = load i64, ptr %.omp.lb, align 8, !tbaa !5
  %add7 = add i64 %1, %0
  %2 = load ptr, ptr %this, align 8, !tbaa !0
...
define i8 @"186"(ptr %arrayidx17.i.i, ptr %agg.tmp11, ptr %max_iters_, i32 %0) {
bb:
  %1 = load i8, ptr %arrayidx17.i.i, align 2, !tbaa !59, !noalias !108
  %2 = load i32, ptr %max_iters_, align 4, !tbaa !100
  %__val.lobit.i = lshr i32 %2, %0
  %conv5.i = zext i32 %__val.lobit.i to i64
  %3 = load ptr, ptr %agg.tmp11, align 8, !tbaa !24, !alias.scope !108
  %arrayidx.i.i = getelementptr inbounds i8, ptr %3, i64 %conv5.i
  store i8 %1, ptr %arrayidx.i.i, align 1, !tbaa !59
  ret i8 %1
}

define i64 @"187"(ptr %add.ptr.i.i.i.i.i, ptr %__first, ptr %add.ptr.i.i.i.i, ptr %add.ptr2.i.i.i.i, ptr %v.i.i.i.i.i.i, ptr %v3.i.i.i.i.i.i, i64 %sub1.i.i.i.i, i64 %mul.i.i.i.i, i64 %0) {
bb:
...
define i32 @"188"(ptr %add.ptr.i.i.i.i.i, ptr %__first, ptr %add.ptr.i.i.i.i, ptr %add.ptr2.i.i.i.i, i64 %sub1.i.i.i.i, i64 %mul.i.i.i.i, i64 %0) {
bb:
...
bb:
  %2 = load ptr, ptr %end_size_, align 8, !tbaa !114
  %sub.ptr.lhs.cast = ptrtoint ptr %2 to i64
...
define i64 @"190"(ptr %el, i64 %0, i64 %1) {
bb:
  %.pre = load ptr, ptr %el, align 8, !tbaa !18
  %incdec.ptr13.i.i.i.i = getelementptr inbounds %struct.EdgePair, ptr %.pre, i64 %0
  %__first.addr.030.i.i = getelementptr inbounds %struct.EdgePair, ptr %incdec.ptr13.i.i.i.i, i64 %1
...
define i32 @"191"(ptr %degrees, ptr %.omp.lb, i64 %0) {
bb:
  %1 = load i64, ptr %.omp.lb, align 8, !tbaa !5
  %mul14 = shl i64 %1, %0
  %2 = load ptr, ptr %degrees, align 8, !tbaa !27
...
define i64 @"192"(ptr %_M_p.i.i.i, i64 %0) {
bb:
  %1 = load i64, ptr %_M_p.i.i.i, align 8, !tbaa !71
  %inc.i71 = add nuw nsw i64 %1, %0
  store i64 %inc.i71, ptr %_M_p.i.i.i, align 8, !tbaa !71
  ret i64 %inc.i71
}

define i64 @"193"(ptr %__begin0.sroa.0.059, i64 %0, ptr %.sroa_idx, ptr %_M_finish.i38, i64 %1) {
bb:
  ...
  %retval.sroa.0.0.insert.insert.i = or i64 %retval.sroa.2.0.insert.shift.i, %retval.sroa.0.0.insert.ext.i
  %4 = load ptr, ptr %_M_finish.i38, align 8, !tbaa !81
...
define ptr @"194"(ptr %cond.i31.i.i.i, i64 %.sroa.speculated.i.i.i.i, ptr %_M_finish.i38, i64 %0, i64 %sub.ptr.rhs.cast.i, i64 %1, i64 %sub.ptr.div.i, i1 %cmp9.i.i.i.i, i64 %2, i64 %add.i.i.i.i, ptr %_M_end_of_storage.i.i) {
bb:
  %3 = load ptr, ptr %_M_finish.i38, align 8, !tbaa !81
...
define float @"195"(ptr %init_val, ptr %this, ptr %.omp.lb, i64 %0, i64 %1, i64 %2) {
bb:
  %3 = load i64, ptr %.omp.lb, align 8, !tbaa !5
  %4 = sub i64 %0, %3
  %n.vec = and i64 %4, %1
...
define i64 @"196"(ptr %__begin0.sroa.0.059, i64 %0, ptr %.sroa_idx, ptr %add.ptr.i.i.i) {
bb:
...
define ptr @"197"(ptr %new_range.i.i457, ptr %0, ptr %el, i64 %1, i64 %sub.ptr.rhs.cast, i64 %2, ptr %end_size_.i) {
bb:
  %.pre = load ptr, ptr %el, align 8, !tbaa !18
  %incdec.ptr7.i.i = getelementptr inbounds %struct.EdgePair, ptr %.pre, i64 %1
  %sub.ptr.lhs.cast = ptrtoint ptr %incdec.ptr7.i.i to i64
...
define <8 x i32> @"198"(ptr %el, ptr %.omp.lb, i64 %index) {
bb:
  %0 = load i64, ptr %.omp.lb, align 8, !tbaa !5
...
define i64 @"199"(ptr %arrayidx.i58, ptr %arrayidx.i58.3, ptr %arrayidx.i58.2, ptr %arrayidx.i58.1, i64 %add7, ptr %arrayidx.i57.1) {
bb:
...
define i64 @"200"(ptr %offsets, ptr %num_nodes_.i, i64 %0, i64 %1) {
bb:
  %2 = load i64, ptr %num_nodes_.i, align 8, !tbaa !79
  %n.mod.vf = and i64 %2, %0
...
define float @"201"(ptr %init_score, ptr %arrayidx.i, ptr %arrayidx4.i.phi.trans.insert, i64 %0, ptr %outgoing_contrib, i32 %cond, ptr %.omp.lb, i64 %1, i64 %2) {
bb:
  %.pre = load ptr, ptr %arrayidx4.i.phi.trans.insert, align 8, !tbaa !15
  ...
  %sub.ptr.div.i = ashr exact i64 %sub.ptr.sub.i, %0
  %conv9 = sitofp i64 %sub.ptr.div.i to float
  %4 = load float, ptr %init_score, align 4, !tbaa !7
  %div10 = fdiv float %4, %conv9
  ...
  %arrayidx.i23 = getelementptr inbounds float, ptr %5, i64 %ind.end
  store float %div10, ptr %arrayidx.i23, align 4, !tbaa !7
  ret float %div10
}

define float @"202"(ptr %init_val, ptr %this, i64 %.omp.iv.018) {
bb:
  %0 = load float, ptr %init_val, align 4, !tbaa !7
...
define ptr @"203"(ptr %call.i5155, ptr %end_size_.i, ptr %degrees, i64 %0, i64 %1, ptr %end_size_.i53) {
bb:
  %2 = load ptr, ptr %degrees, align 8, !tbaa !27
...
bb:
  %0 = load ptr, ptr %out_index.i, align 8, !tbaa !15, !noalias !83
  %1 = load i64, ptr %num_nodes_.i, align 8, !tbaa !9, !noalias !83
  %arrayidx.i.i = getelementptr inbounds ptr, ptr %0, i64 %1
  %2 = load ptr, ptr %arrayidx.i.i, align 8, !tbaa !15, !noalias !83
  ret ptr %2
}
...
bb:
  %1 = load i8, ptr %transpose, align 1, !tbaa !76, !range !77, !noundef !78
...
define i64 @"211"(ptr %v, i32 %0, i64 %1, i64 %agg.tmp93.sroa.0.0.insert.ext, ptr %2) {
bb:
  %3 = load i32, ptr %v, align 4, !tbaa !19
  %sub = add nsw i32 %3, %0
  %agg.tmp.sroa.2.0.insert.ext = zext i32 %sub to i64
...
define i32 @"212"(ptr %top_k, i64 %0) {
bb:
...
define i32 @"213"(ptr %el, ptr %.omp.lb, i64 %0, i64 %1, i64 %2) {
bb:
  %3 = load i64, ptr %.omp.lb, align 8, !tbaa !5
  %4 = sub i64 %0, %3
  %n.vec = and i64 %4, %1
...
define i32 @"215"(ptr %el, ptr %.omp.lb, i64 %0, i64 %1) {
bb:
  %2 = load i64, ptr %.omp.lb, align 8, !tbaa !5
  %3 = sub i64 %0, %2
  %n.vec = and i64 %3, %1
...
define ptr @"216"(ptr %neighs, ptr %arrayidx.i, ptr %index, ptr %.omp.lb) {
bb:
  %0 = load i32, ptr %.omp.lb, align 4, !tbaa !22
  %1 = sext i32 %0 to i64
  %2 = load ptr, ptr %index, align 8, !tbaa !15
...
define i64 @"217"(ptr %end_size_.i, ptr %degrees, i64 %0, i64 %1, i64 %2, ptr %num_blocks) {
bb:
  %3 = load ptr, ptr %degrees, align 8, !tbaa !27
  %sub.ptr.rhs.cast.i = ptrtoint ptr %3 to i64
  %4 = load ptr, ptr %end_size_.i, align 8, !tbaa !46
...
define i64 @"218"(ptr %arrayidx.i58.3, ptr %arrayidx.i58.2, ptr %arrayidx.i58.1, ptr %arrayidx.i58, i64 %total.076, ptr %arrayidx.i57) {
bb:
  %0 = load i64, ptr %arrayidx.i58, align 8, !tbaa !5
  %add7 = add nsw i64 %0, %total.076
  %1 = load i64, ptr %arrayidx.i58.1, align 8, !tbaa !5
...
define i64 @"219"(ptr %add.ptr3.i.i.i, ptr %__first, ptr %add.ptr.i.i.i, ptr %add.ptr2.i.i.i, ptr %v.i.i.i.i.i, ptr %v3.i.i.i.i.i, i64 %sub1.i.i.i, i64 %mul.i.i.i) {
bb:
...
define ptr @"220"(ptr %el, ptr %0, i64 %1, i64 %sub.ptr.rhs.cast, i64 %2, ptr %end_size_.i) {
bb:
  %.pre = load ptr, ptr %el, align 8, !tbaa !18
  %incdec.ptr7.i.i = getelementptr inbounds %struct.EdgePair, ptr %.pre, i64 %1
  %sub.ptr.lhs.cast = ptrtoint ptr %incdec.ptr7.i.i to i64
...
define i32 @"221"(ptr %e.sroa.5.0..sroa_idx, ptr %0, ptr %offsets, ptr %add.ptr, i64 %1) {
bb:
  ...
  %e.sroa.5.0.copyload = load i32, ptr %e.sroa.5.0..sroa_idx, align 4, !tbaa.struct !116
  store i32 %e.sroa.5.0.copyload, ptr %arrayidx, align 4, !tbaa !22
  ret i32 %e.sroa.5.0.copyload
}

define float @"222"(ptr %arrayidx.i.1, ptr %second3.i.1) {
bb:
...
define i64 @"223"(ptr %new_range.i.i, i64 %0) {
bb:
  %1 = load ptr, ptr %new_range.i.i, align 8, !tbaa !15
...
define <8 x i32> @"224"(ptr %el, ptr %.omp.lb, i64 %index, i64 %0) {
bb:
  %1 = load ptr, ptr %el, align 8, !tbaa !18
  %2 = load i64, ptr %.omp.lb, align 8, !tbaa !5
...
define i32 @"226"(i32 %0, ptr %call171, ptr %arrayidx.i548, i64 %1, ptr %arrayidx.i549) {
bb:
...
define ptr @"228"(ptr %new_range.i.i457, ptr %el, i64 %0, i64 %1, ptr %end_capacity_.i.i.i) {
bb:
  %.pre = load ptr, ptr %el, align 8, !tbaa !18
  %incdec.ptr13.i.i.i.i = getelementptr inbounds %struct.EdgePair, ptr %.pre, i64 %0
  %sub.ptr.lhs.cast11 = ptrtoint ptr %incdec.ptr13.i.i.i.i to i64
...
define i8 @"229"(ptr %0, ptr %opt_arg) {
bb:
  %1 = load ptr, ptr %opt_arg, align 8, !tbaa !24
  %2 = load i8, ptr %0, align 8, !tbaa !59
  store i8 %2, ptr %1, align 1, !tbaa !59
  ret i8 %2
}
...
define i64 @"231"(ptr %incdec.ptr126.i.i, ptr %el, i64 %0) {
bb:
...
define float @"232"(ptr %arrayidx.i.prol, ptr %call5.i.i.i.i4.i.i45, ptr %num_nodes_.i, i64 %0, i32 %1) {
bb:
...
define i32 @"233"(ptr %num_nodes, i64 %0, ptr %length.i) {
bb:
  %1 = load i64, ptr %num_nodes, align 8, !tbaa !5
  %add = add nsw i64 %1, %0
...
define ptr @"234"(ptr %new_range.i.i, ptr %el, i64 %0, i64 %sub.ptr.rhs.cast, i64 %1, ptr %end_size_.i) {
bb:
  %.pre = load ptr, ptr %el, align 8, !tbaa !18
  %incdec.ptr7.i.i = getelementptr inbounds %struct.EdgePair, ptr %.pre, i64 %0
  %sub.ptr.lhs.cast = ptrtoint ptr %incdec.ptr7.i.i to i64
...
define ptr @"235"(ptr %el, i64 %sub.ptr.rhs.cast, i64 %0, ptr %end_size_.i) {
bb:
  %1 = load ptr, ptr %el, align 8, !tbaa !18
  %sub.ptr.lhs.cast = ptrtoint ptr %1 to i64
  %sub.ptr.sub = sub i64 %sub.ptr.lhs.cast, %sub.ptr.rhs.cast
...
define i64 @"236"(ptr %arrayidx.i533, i64 %total_missing_inv.0.lcssa) {
bb:
...
define <4 x i32> @"237"(ptr %0, ptr %call171, i64 %tail_index.0660, ptr %arrayidx.i542, ptr %arrayidx.i540, ptr %arrayidx.i541, i64 %1, i64 %index800, i64 %2) {
bb:
  %3 = load i64, ptr %arrayidx.i542, align 8, !tbaa !5
  %4 = load i64, ptr %arrayidx.i540, align 8, !tbaa !5
  %5 = load i32, ptr %arrayidx.i541, align 4, !tbaa !22
...
define i32 @"238"(ptr %num_nodes_.i, i64 %0, ptr %add.ptr.i) {
bb:
  %1 = load i64, ptr %num_nodes_.i, align 8, !tbaa !9
  %n.vec = and i64 %1, %0
  %2 = trunc i64 %n.vec to i32
...
define float @"239"(ptr %scores, ptr %num_nodes_.i, i64 %0) {
bb:
  %1 = load i64, ptr %num_nodes_.i, align 8, !tbaa !9
  %n.vec = and i64 %1, %0
  %2 = load ptr, ptr %scores, align 8, !tbaa !0
...
define i64 @"240"(ptr %offsets, ptr %num_nodes_.i, i32 %0, i64 %1) {
bb:
  %2 = load i64, ptr %num_nodes_.i, align 8, !tbaa !79
  %3 = trunc i64 %2 to i32
  %n184.0657 = add i32 %3, %0
...
define i32 @"241"(ptr %el, ptr %.omp.lb, i64 %0) {
bb:
  %1 = load i64, ptr %.omp.lb, align 8, !tbaa !5
  %2 = load ptr, ptr %el, align 8, !tbaa !18
...
define float @"242"(ptr %init_val, ptr %this, ptr %.omp.lb) {
bb:
...
define i32 @"243"(ptr %__first.addr.033.i.i, ptr %n_start.0.in) {
bb:
  %n_start.0 = load ptr, ptr %n_start.0.in, align 8, !tbaa !15
...
define double @"244"(ptr %0, ptr %1, ptr %2) {
bb:
...
define i8 @"245"(ptr %arrayidx17.i.i, ptr %ref.tmp, i64 %conv5.i) {
bb:
...
define i32 @"246"(ptr %e.sroa.4.0..sroa_idx, ptr %el, ptr %arrayidx.i) {
bb:
  %e.sroa.4.0.copyload = load i32, ptr %e.sroa.4.0..sroa_idx, align 4, !tbaa.struct !116
...
define ptr @"247"(ptr %out_index_.i, i32 %cond, ptr %.omp.lb, i64 %0, i64 %1) {
bb:
  ...
  %8 = load ptr, ptr %arrayidx.i.prol, align 8, !tbaa !15
  ret ptr %8
}

define i64 @"248"(ptr %_M_string_length.i23.i.i.i.phi.trans.insert, ptr %cond.i31, i64 %sub.ptr.lhs.cast.i, ptr %this, i64 %0, i32 %1) {
bb:
  %2 = load ptr, ptr %this, align 8, !tbaa !15
  %sub.ptr.rhs.cast.i.i = ptrtoint ptr %2 to i64
  %sub.ptr.sub.i = sub i64 %sub.ptr.lhs.cast.i, %sub.ptr.rhs.cast.i.i
...
define i32 @"250"(ptr %.omp.lb, ptr %permutation, i64 %indvars.iv) {
bb:
  %0 = load i32, ptr %.omp.lb, align 4, !tbaa !22
  %1 = sext i32 %0 to i64
...
define i64 @"251"(ptr %arrayidx.i492.1, ptr %offsets, ptr %num_nodes_.i, i64 %0, i64 %1) {
bb:
  %2 = load ptr, ptr %offsets, align 8
  %3 = load i64, ptr %num_nodes_.i, align 8, !tbaa !79
  %n.mod.vf = and i64 %3, %0
...
define i32 @"252"(ptr %el, ptr %.omp.lb, i64 %0) {
bb:
  %1 = load i64, ptr %.omp.lb, align 8, !tbaa !5
  %add15 = add i64 %1, %0
  %2 = load ptr, ptr %el, align 8, !tbaa !18
...
define float @"253"(float %0, ptr %arrayidx.i71, ptr %arrayidx4.i, i64 %1, ptr %outgoing_contrib, ptr %.omp.lb) {
bb:
  %2 = load ptr, ptr %outgoing_contrib, align 8
  %3 = load i32, ptr %.omp.lb, align 4, !tbaa !22
  %4 = sext i32 %3 to i64
  %arrayidx.i72 = getelementptr inbounds float, ptr %2, i64 %4
  %5 = load ptr, ptr %arrayidx.i71, align 8, !tbaa !15, !llvm.access.group !33
  %sub.ptr.lhs.cast.i = ptrtoint ptr %5 to i64
  %6 = load ptr, ptr %arrayidx4.i, align 8, !tbaa !15, !llvm.access.group !33
...
define i64 @"254"(ptr %this, ptr %.omp.lb) {
bb:
  %0 = load i64, ptr %.omp.lb, align 8, !tbaa !5
...
define i64 @"256"(ptr %0, ptr %_M_finish.i38, i64 %1, i64 %2, i64 %3, i64 %4, i64 %5) {
bb:
  %6 = load ptr, ptr %_M_finish.i38, align 8, !tbaa !81
  ...
  %13 = load i64, ptr %ind.end64, align 4, !alias.scope !95, !noalias !98
  ret i64 %13
}

define float @"257"(ptr %init_score, ptr %arrayidx.i.1, ptr %arrayidx.i, i64 %0, ptr %outgoing_contrib, i32 %cond, ptr %.omp.lb, i64 %1, i64 %2) {
bb:
  %3 = load ptr, ptr %arrayidx.i.1, align 8, !tbaa !15
  %sub.ptr.lhs.cast.i.1 = ptrtoint ptr %3 to i64
  %4 = load ptr, ptr %arrayidx.i, align 8, !tbaa !15
  ...
  %arrayidx.i23.1 = getelementptr inbounds float, ptr %6, i64 %indvars.iv.next
  store float %div10.1, ptr %arrayidx.i23.1, align 4, !tbaa !7
  ret float %div10.1
}

define ptr @"258"(ptr %neighs, ptr %arrayidx.i.prol, ptr %index, ptr %.omp.lb) {
bb:
...
define float @"259"(ptr %init_score, ptr %arrayidx.i, ptr %arrayidx.i.prol, i64 %0, ptr %outgoing_contrib, i32 %cond, ptr %.omp.lb, i64 %1, i64 %2) {
bb:
  %3 = load ptr, ptr %arrayidx.i.prol, align 8, !tbaa !15
  %sub.ptr.rhs.cast.i = ptrtoint ptr %3 to i64
  %4 = load ptr, ptr %arrayidx.i, align 8, !tbaa !15
...
define i32 @"261"(ptr %el, ptr %.omp.lb, i64 %0, i64 %1, i64 %2, i64 %3) {
bb:
...
define i32 @"262"(i64 %indvars.iv699, ptr %incdec.ptr4.sink.i.i.i.i569, ptr %__first.addr.015.i.i563, ptr %call171, ptr %arrayidx.i550, i64 %sub.ptr.rhs.cast.i.i.i.i552, i64 %0, i64 %1) {
bb:
  %2 = load i64, ptr %arrayidx.i550, align 8, !tbaa !5
  %add.ptr271 = getelementptr inbounds i32, ptr %call171, i64 %2
  %sub.ptr.lhs.cast.i.i.i.i551 = ptrtoint ptr %add.ptr271 to i64
...
define ptr @"263"(ptr %transpose, i8 %0, ptr %out_index_.i, ptr %in_index_.i, i64 %1) {
bb:
  %2 = load i8, ptr %transpose, align 1, !tbaa !76, !range !77, !noundef !78
...
!67 = distinct !{!67, !65}
!68 = !{!69}
!69 = distinct !{!69, !70, !"_ZStplIcSt11char_traitsIcESaIcEENSt7__cxx1112basic_stringIT_T0_T1_EERKS8_PKS5_: %agg.result"}
!70 = distinct !{!70, !"_ZStplIcSt11char_traitsIcESaIcEENSt7__cxx1112basic_stringIT_T0_T1_EERKS8_PKS5_"}
!71 = !{!72, !6, i64 4992}
!72 = !{!"_ZTSSt23mersenne_twister_engineImLm32ELm624ELm397ELm31ELm2567483615ELm11ELm4294967295ELm7ELm2636928640ELm15ELm4022730752ELm18ELm1812433253EE", !3, i64 0, !6, i64 4992}
!73 = !{!74}
...
!78 = !{}
!79 = !{!80, !6, i64 16}
!80 = !{!"_ZTS11BuilderBaseIiiiLb1EE", !2, i64 0, !11, i64 8, !11, i64 9, !11, i64 10, !6, i64 16}
!81 = !{!82, !2, i64 8}
!82 = !{!"_ZTSNSt12_Vector_baseISt4pairIfiESaIS1_EE17_Vector_impl_dataE", !2, i64 0, !2, i64 8, !2, i64 16}
!83 = !{!84}
...
!90 = !{!91}
!91 = distinct !{!91, !92, !"_ZSt19__relocate_object_aINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEES5_SaIS5_EEvPT_PT0_RT1_: %__orig"}
!92 = distinct !{!92, !"_ZSt19__relocate_object_aINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEES5_SaIS5_EEvPT_PT0_RT1_"}
!93 = !{!94}
!94 = distinct !{!94, !92, !"_ZSt19__relocate_object_aINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEES5_SaIS5_EEvPT_PT0_RT1_: %__dest"}
!95 = !{!96}
!96 = distinct !{!96, !97, !"_ZSt19__relocate_object_aISt4pairIfiES1_SaIS1_EEvPT_PT0_RT1_: %__orig"}
!97 = distinct !{!97, !"_ZSt19__relocate_object_aISt4pairIfiES1_SaIS1_EEvPT_PT0_RT1_"}
!98 = !{!99}
!99 = distinct !{!99, !97, !"_ZSt19__relocate_object_aISt4pairIfiES1_SaIS1_EEvPT_PT0_RT1_: %__dest"}
!100 = !{!101, !14, i64 172}
!101 = !{!"_ZTS10CLPageRank", !102, i64 0, !14, i64 172, !53, i64 176}
!102 = !{!"_ZTS5CLApp", !103, i64 0, !11, i64 155, !14, i64 156, !6, i64 160, !11, i64 168, !11, i64 169}
!103 = !{!"_ZTS6CLBase", !14, i64 8, !2, i64 16, !25, i64 24, !25, i64 56, !104, i64 88, !14, i64 112, !14, i64 116, !25, i64 120, !11, i64 152, !11, i64 153, !11, i64 154}
...
!107 = !{!"_ZTSNSt12_Vector_baseINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEESaIS5_EE17_Vector_impl_dataE", !2, i64 0, !2, i64 8, !2, i64 16}
!108 = !{!109}
