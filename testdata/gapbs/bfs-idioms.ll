...
define i32 @"14"(ptr %arrayidx.i7.i.i) {
bb:
...
define i64 @"15"(ptr %front, ptr %__begin3.064, i64 %0) {
bb:
...
define i32 @"16"(ptr %__first.addr.033.i.i, ptr %n_start.0.in) {
bb:
...
define i32 @"17"(ptr %degrees, ptr %.omp.lb, i64 %0) {
bb:
  %1 = load i64, ptr %.omp.lb, align 8, !tbaa !8
  %mul14 = shl i64 %1, %0
  %2 = load ptr, ptr %degrees, align 8, !tbaa !0
...
define i32 @"18"(ptr %el, i64 %0, i64 %1, i32 %2) {
bb:
  %.pre = load ptr, ptr %el, align 8, !tbaa !37
...
define i64 @"19"(ptr %awake_count7, ptr %awake_count) {
bb:
...
define i64 @"20"(ptr %offsets, ptr %num_nodes_.i, i32 %0, i64 %1) {
bb:
  %2 = load ptr, ptr %offsets, align 8, !tbaa !6
  %3 = load i64, ptr %num_nodes_.i, align 8, !tbaa !42
...
define i32 @"21"(ptr %el, ptr %.omp.lb, i64 %0) {
bb:
...
define i32 @"22"(ptr %init_val, ptr %this, ptr %.omp.lb) {
bb:
...
define ptr @"23"(ptr %new_range.i.i, ptr %end_size_.i, i64 %sub.ptr.rhs.cast, i64 %0) {
bb:
  %.pre709 = load ptr, ptr %end_size_.i, align 8, !tbaa !39
  %sub.ptr.lhs.cast = ptrtoint ptr %.pre709 to i64
  %sub.ptr.sub = sub i64 %sub.ptr.lhs.cast, %sub.ptr.rhs.cast
...
define ptr @"24"(ptr %new_range.i.i457, ptr %0, ptr %el, i64 %1, i64 %sub.ptr.rhs.cast, i64 %2, ptr %end_capacity_.i.i.i) {
bb:
  %.pre711 = load ptr, ptr %el, align 8, !tbaa !37
  %.pre730 = ptrtoint ptr %.pre711 to i64
  %.pre = load ptr, ptr %el, align 8, !tbaa !37
  ...
  store ptr %add.ptr6.i.i478, ptr %end_capacity_.i.i.i, align 8, !tbaa !44
  ret ptr %add.ptr6.i.i478
}

define i32 @"25"(ptr %add.ptr3.i.i.i.i, ptr %__first, ptr %add.ptr.i.i.i.i, ptr %add.ptr2.i.i.i.i, i64 %sub1.i.i.i.i, i64 %mul.i.i.i.i) {
bb:
...
define i64 @"26"(ptr %_M_string_length.i.i.i.i, ptr %cond.i31, i64 %sub.ptr.lhs.cast.i, ptr %this, i64 %0, i32 %1) {
bb:
...
define i64 @"27"(ptr %arrayidx.i58, ptr %arrayidx.i58.3, ptr %arrayidx.i58.2, ptr %arrayidx.i58.1, i64 %add7, ptr %arrayidx.i57.1) {
bb:
...
define i32 @"28"(ptr %num_nodes, i64 %0, ptr %length.i) {
bb:
...
define i64 @"29"(ptr %arrayidx23.i.i, i64 %0, ptr %1, i64 %2, i64 %3, ptr %arrayidx28.i.i, i64 %4, i64 %5, ptr %udist_, i64 %6) {
bb:
  %7 = load ptr, ptr %udist_, align 8, !tbaa !46
...
bb:
  %1 = load i64, ptr %_M_p.i.i.i, align 8, !tbaa !48
  %inc.i71 = add nuw nsw i64 %1, %0
  %inc.i64 = add nuw nsw i64 %inc.i71, %0
  store i64 %inc.i64, ptr %_M_p.i.i.i, align 8, !tbaa !48
  ret i64 %inc.i64
}
...
bb:
  ...
  %2 = load i32, ptr %v, align 4, !tbaa !50
  %sub = add nsw i32 %2, %0
  ...
  store i64 %agg.tmp.sroa.0.0.insert.insert, ptr %.pre.pre.i, align 4, !tbaa.struct !52
...
bb:
  ...
  %e.sroa.4.0.copyload = load i32, ptr %e.sroa.4.0..sroa_idx, align 4, !tbaa.struct !53
  store i32 %e.sroa.4.0.copyload, ptr %arrayidx, align 4, !tbaa !10
  ret i32 %e.sroa.4.0.copyload
}

define i32 @"34"(ptr %end_size_.i, ptr %offsets, i64 %0, ptr %length.i136) {
bb:
...
define i64 @"35"(ptr %arrayidx.i59, i64 %0, ptr %.omp.lb, i64 %1, ptr %next, i64 %div1.i.i58) {
bb:
...
bb:
  %0 = load i64, ptr %num_nodes_.i, align 8, !tbaa !55, !noalias !57
  %1 = load ptr, ptr %out_index.i, align 8, !tbaa !16, !noalias !57
  %arrayidx.i.i = getelementptr inbounds ptr, ptr %1, i64 %0
  %2 = load ptr, ptr %arrayidx.i.i, align 8, !tbaa !16, !noalias !57
  ret ptr %2
}
...
bb:
  ...
  %3 = load i32, ptr %v, align 4, !tbaa !50
  %sub = add nsw i32 %3, %0
  %agg.tmp.sroa.2.0.insert.ext = zext i32 %sub to i64
  %agg.tmp.sroa.2.0.insert.shift = shl nuw i64 %agg.tmp.sroa.2.0.insert.ext, %1
  %agg.tmp.sroa.0.0.insert.insert = or i64 %agg.tmp.sroa.2.0.insert.shift, %agg.tmp93.sroa.0.0.insert.ext
  store i64 %agg.tmp.sroa.0.0.insert.insert, ptr %2, align 4, !tbaa.struct !52
  ret i64 %agg.tmp.sroa.0.0.insert.insert
}
...
define <2 x i64> @"42"(ptr %0, <2 x i64> %1, <2 x i64> %2, <2 x i64> %3, ptr %4, <2 x i64> %5, <2 x i64> %6, ptr %udist_, i64 %7, i64 %index15) {
bb:
  %8 = load ptr, ptr %udist_, align 8, !tbaa !46
...
bb:
  ...
  %agg.tmp.sroa.0.0.copyload.i58.i.i.i.i = load i64, ptr %incdec.ptr.i.i.i.i, align 4, !tbaa.struct !52
...
define i32 @"46"(ptr %arrayidx.i247, i32 %0, ptr %depth, ptr %__begin2.0527) {
bb:
...
bb:
  ...
  store i64 %conv, ptr %num_nodes_, align 8, !tbaa !42
  ret i64 %conv
}
...
bb:
  ...
  store ptr %add.ptr6.i.i, ptr %end_capacity_.i.i.i, align 8, !tbaa !44
...
bb:
  ...
  %agg.tmp.sroa.0.0.copyload.i73.i.i.i.i = load i64, ptr %incdec.ptr13.i.i.i.i, align 4, !tbaa.struct !52
  ret i64 %agg.tmp.sroa.0.0.copyload.i73.i.i.i.i
}

define i64 @"51"(ptr %0, i64 %1, ptr %arrayidx42.i.i, i64 %2, i64 %3, ptr %arrayidx49.i.i, i64 %4, i64 %5, ptr %udist_, i64 %6) {
bb:
  ...
  %10 = load ptr, ptr %udist_, align 8, !tbaa !46
...
define i32 @"52"(ptr %el, ptr %.omp.lb) {
bb:
...
define i32 @"54"(ptr %.omp.lb, ptr %permutation, i64 %indvars.iv) {
bb:
...
define ptr @"55"(ptr %new_range.i.i, ptr %el, i64 %0, i64 %sub.ptr.rhs.cast, i64 %1, ptr %end_size_.i) {
bb:
  %.pre = load ptr, ptr %el, align 8, !tbaa !37
...
define ptr @"56"(ptr %this, i64 %0, i32 %1, ptr %__first.addr.07.i.i.i.i) {
bb:
  %2 = load ptr, ptr %this, align 8, !tbaa !16
  %3 = getelementptr inbounds %"class.std::__cxx11::basic_string", ptr %2, i64 %0, i32 2
  store ptr %3, ptr %__first.addr.07.i.i.i.i, align 8, !tbaa !35, !alias.scope !60, !noalias !63
  ret ptr %3
}

define i32 @"57"(ptr %call171, ptr %arrayidx.i542, i64 %0, i64 %total_missing_inv.1659, ptr %arrayidx.i541) {
bb:
...
define i64 @"58"(ptr %arrayidx.i58.3, ptr %arrayidx.i58.2, ptr %arrayidx.i58.1, ptr %arrayidx.i58, i64 %total.076, ptr %arrayidx.i57) {
bb:
  %0 = load i64, ptr %arrayidx.i58.3, align 8, !tbaa !8
  %1 = load i64, ptr %arrayidx.i58.2, align 8, !tbaa !8
...
define i32 @"59"(ptr %call171, ptr %arrayidx.i542, ptr %arrayidx.i540, ptr %arrayidx.i541, i64 %0, i64 %1, i64 %total_missing_inv.0649, ptr %arrayidx.i536) {
bb:
...
define i64 @"60"(ptr %add.ptr.i.i.i.i.i, ptr %__first, ptr %add.ptr.i.i.i.i, ptr %add.ptr2.i.i.i.i, ptr %v.i.i.i.i.i.i, ptr %v3.i.i.i.i.i.i, i64 %sub1.i.i.i.i, i64 %mul.i.i.i.i, i64 %0) {
bb:
...
define ptr @"61"(ptr %cond.i31, i64 %sub.ptr.lhs.cast.i, ptr %this, i64 %0, i32 %1, ptr %add.ptr) {
bb:
  %2 = load ptr, ptr %this, align 8, !tbaa !16
...
define i64 @"62"(ptr %this, ptr %.omp.lb) {
bb:
  %0 = load i64, ptr %.omp.lb, align 8, !tbaa !8
...
define <2 x i64> @"63"(ptr %0, <2 x i64> %1, <2 x i64> %2, ptr %rng, i64 %3, <2 x i64> %4, <2 x i64> %5, ptr %6, <2 x i64> %7, <2 x i64> %8, ptr %9) {
bb:
...
define i32 @"64"(ptr %arrayidx212, ptr %call171, ptr %arrayidx.i539, i64 %0) {
bb:
...
define <4 x i32> @"65"(ptr %call171, ptr %arrayidx.i542, i64 %0, i64 %total_missing_inv.0649, ptr %arrayidx.i536, i64 %1) {
bb:
  %2 = load i64, ptr %arrayidx.i542, align 8, !tbaa !8
  %3 = add i64 %2, %0
...
define i32 @"66"(i64 %indvars.iv699, ptr %incdec.ptr4.sink.i.i.i.i569, ptr %__first.addr.015.i.i563, ptr %call171, ptr %arrayidx.i550, i64 %sub.ptr.rhs.cast.i.i.i.i552, i64 %0, i64 %1) {
bb:
...
define <4 x i32> @"67"(<4 x i32> %0, ptr %init_val, i64 %1, ptr %this, ptr %.omp.lb, i64 %index) {
bb:
  %2 = load i64, ptr %.omp.lb, align 8, !tbaa !8
...
define <4 x i32> @"68"(ptr %call171, ptr %arrayidx.i542, i64 %0, i64 %total_missing_inv.1659, ptr %arrayidx.i541, i64 %1) {
bb:
  %2 = load i64, ptr %arrayidx.i542, align 8, !tbaa !8
  %3 = add i64 %2, %0
  %.pre717 = load i32, ptr %arrayidx.i541, align 4, !tbaa !10
...
define i32 @"69"(ptr %init_val, ptr %this, ptr %.omp.lb, i64 %0, i64 %1, i64 %2) {
bb:
...
define i64 @"70"(i64 %val.coerce, ptr %new_range.i, ptr %end_size_.i, ptr %this, i64 %0) {
bb:
  ...
  store i64 %val.coerce, ptr %add.ptr.i, align 4, !tbaa.struct !52
  ret i64 %val.coerce
}

define <8 x i32> @"71"(ptr %el, ptr %.omp.lb, i64 %index, i64 %0) {
bb:
  %1 = load i64, ptr %.omp.lb, align 8, !tbaa !8
...
define i64 @"72"(ptr %new_range.i.i, i64 %0, i64 %1) {
bb:
  %.pre.i.i = load ptr, ptr %new_range.i.i, align 8, !tbaa !16
  %incdec.ptr13.i.i.i.i = getelementptr inbounds %struct.EdgePair, ptr %.pre.i.i, i64 %0
...
define i32 @"73"(ptr %__first, ptr %add.ptr.i.i.i.i, ptr %add.ptr2.i.i.i.i, i64 %sub1.i.i.i.i, i64 %mul.i.i.i.i, i64 %0, i64 %1) {
bb:
  %2 = load i32, ptr %add.ptr.i.i.i.i, align 4, !tbaa !10
  %3 = load i32, ptr %add.ptr2.i.i.i.i, align 4, !tbaa !10
  %cmp.i.i.i.i.i = icmp slt i32 %2, %3
...
define ptr @"74"(ptr %neighs, ptr %arrayidx.i.prol, ptr %index, ptr %.omp.lb) {
bb:
...
define <2 x i64> @"75"(ptr %0, <2 x i64> %1, <2 x i64> %2, ptr %3, i64 %4, <2 x i64> %5, <2 x i64> %6, ptr %7, <2 x i64> %8, <2 x i64> %9, ptr %udist_, i64 %10, i64 %index15) {
bb:
  %11 = load ptr, ptr %udist_, align 8, !tbaa !46
...
define ptr @"76"(ptr %new_range.i.i, ptr %0, ptr %el, i64 %1, i64 %sub.ptr.rhs.cast, i64 %2, ptr %end_size_.i) {
bb:
  %.pre.i.i = load ptr, ptr %new_range.i.i, align 8, !tbaa !16
  %.pre711 = load ptr, ptr %el, align 8, !tbaa !37
  %.pre730 = ptrtoint ptr %.pre711 to i64
...
define ptr @"77"(ptr %neighs, ptr %arrayidx.i.1, ptr %index, ptr %.omp.lb, i64 %0) {
bb:
...
define i64 @"78"(ptr %arrayidx.i492.1, ptr %offsets, ptr %num_nodes_.i, i64 %0, i64 %1) {
bb:
...
define i32 @"79"(ptr %neighs, ptr %arrayidx.i522) {
bb:
...
define i64 @"80"(ptr %_M_p.i.i.i, i64 %0) {
bb:
  %1 = load i64, ptr %_M_p.i.i.i, align 8, !tbaa !48
  %inc.i71 = add nuw nsw i64 %1, %0
  %inc.i207 = add nuw nsw i64 %inc.i71, %0
  %inc.i139 = add nuw nsw i64 %inc.i207, %0
  store i64 %inc.i139, ptr %_M_p.i.i.i, align 8, !tbaa !48
  ret i64 %inc.i139
}
...
define i32 @"82"(ptr %.omp.lb, ptr %arrayidx.i27) {
bb:
  %0 = load i32, ptr %.omp.lb, align 4, !tbaa !10
  %1 = sext i32 %0 to i64
  %2 = trunc i64 %1 to i32
...
define i64 @"86"(ptr %arrayidx.i, ptr %prefix, ptr %.omp.lb, i64 %0) {
bb:
  %1 = load i64, ptr %.omp.lb, align 8, !tbaa !8
  %mul14 = shl i64 %1, %0
...
define i32 @"87"(ptr %queue, ptr %shared_out_start.i, ptr %.omp.lb) {
bb:
  %0 = load ptr, ptr %queue, align 8, !tbaa !66
  %1 = load i64, ptr %shared_out_start.i, align 8, !tbaa !68
...
bb:
  ...
  %0 = load i64, ptr %num_nodes_.i, align 8, !tbaa !42
...
bb:
  %2 = load i64, ptr %_M_p.i.i.i, align 8, !tbaa !48
...
bb:
  %3 = load ptr, ptr %0, align 8, !tbaa !16, !noalias !57
  %sub.ptr.rhs.cast.i20.i = ptrtoint ptr %3 to i64
  %4 = load ptr, ptr %arrayidx.i18.i, align 8, !tbaa !16, !noalias !57
  ...
  store i64 %div.i.i, ptr %2, align 8, !alias.scope !57
  ret i64 %div.i.i
}
...
define i32 @"93"(ptr %__first.addr.033.i.i, ptr %n_start.0.in, i64 %0) {
bb:
...
define i64 @"95"(ptr %new_range.i.i) {
bb:
  %.pre.i.i = load ptr, ptr %new_range.i.i, align 8, !tbaa !16
  %agg.tmp.sroa.0.0.copyload.i.i.i.i.i = load i64, ptr %.pre.i.i, align 4, !tbaa.struct !52
  ret i64 %agg.tmp.sroa.0.0.copyload.i.i.i.i.i
}

define i32 @"96"(ptr %neighs, ptr %arrayidx.i523) {
bb:
  %0 = load ptr, ptr %neighs, align 8, !tbaa !16
...
define i32 @"97"(ptr %n_start.0.in, i64 %0, i64 %1, ptr %diffs, ptr %.omp.lb) {
bb:
...
define ptr @"98"(ptr %new_range.i.i457, ptr %new_range.i.i, i64 %0, ptr %el, i64 %1, ptr %end_capacity_.i.i.i) {
bb:
  %.pre711 = load ptr, ptr %el, align 8, !tbaa !37
  %.pre730 = ptrtoint ptr %.pre711 to i64
  %.pre.i.i = load ptr, ptr %new_range.i.i, align 8, !tbaa !16
...
define i32 @"99"(ptr %__first, ptr %add.ptr.i.i.i, ptr %add.ptr2.i.i.i, ptr %v.i.i.i.i.i, ptr %v3.i.i.i.i.i, i64 %sub1.i.i.i, i64 %mul.i.i.i, i64 %0, i64 %1) {
bb:
...
define ptr @"100"(ptr %cond.i31, i64 %.sroa.speculated.i, ptr %_M_finish.i.i, ptr %this, i64 %0, i64 %sub.ptr.div.i.i, i1 %cmp9.i, i64 %1, i64 %add.i, ptr %_M_end_of_storage) {
bb:
  %2 = load ptr, ptr %this, align 8, !tbaa !16
  %sub.ptr.rhs.cast.i.i = ptrtoint ptr %2 to i64
  %3 = load ptr, ptr %_M_finish.i.i, align 8, !tbaa !69
...
define i32 @"101"(ptr %init_val, ptr %this, ptr %.omp.lb, i64 %0, i64 %1) {
bb:
  %2 = load i32, ptr %init_val, align 4, !tbaa !10
  %3 = load ptr, ptr %this, align 8, !tbaa !0
  %4 = load i64, ptr %.omp.lb, align 8, !tbaa !8
...
define ptr @"102"(ptr %el, i64 %0, i64 %sub.ptr.rhs.cast, i64 %1, ptr %end_size_.i) {
bb:
  %.pre = load ptr, ptr %el, align 8, !tbaa !37
  %incdec.ptr7.i.i = getelementptr inbounds %struct.EdgePair, ptr %.pre, i64 %0
  %sub.ptr.lhs.cast = ptrtoint ptr %incdec.ptr7.i.i to i64
...
define <4 x i32> @"103"(ptr %0, ptr %call171, i64 %tail_index.0660, ptr %arrayidx.i542, ptr %arrayidx.i540, ptr %arrayidx.i541, i64 %1, i64 %index800, i64 %2) {
bb:
  %3 = load i32, ptr %arrayidx.i541, align 4, !tbaa !10
  %conv198 = sext i32 %3 to i64
  %4 = load i64, ptr %arrayidx.i540, align 8, !tbaa !8
...
define i8 @"104"(ptr %label) {
bb:
  %0 = load ptr, ptr %label, align 8, !tbaa !35, !noalias !71
  %1 = load i8, ptr %0, align 1, !tbaa !22
  ret i8 %1
}

define ptr @"105"(ptr %__args, ptr %cond.i31, i64 %sub.ptr.lhs.cast.i, ptr %this, i64 %0) {
bb:
...
define i64 @"106"(ptr %incdec.ptr126.i.i, ptr %el, i64 %0) {
bb:
...
define ptr @"107"(ptr %index.i137, ptr %0) {
bb:
...
define i64 @"108"(ptr %arrayidx.i492.prol, ptr %offsets, ptr %num_nodes_.i, i64 %0) {
bb:
  %1 = load ptr, ptr %offsets, align 8
  %2 = load i64, ptr %num_nodes_.i, align 8, !tbaa !42
  %3 = and i64 %2, %0
...
define i64 @"109"(ptr %arrayidx.i492, ptr %offsets, ptr %num_nodes_.i, i64 %0) {
bb:
...
define ptr @"110"(ptr %new_range.i.i457, ptr %0, ptr %end_size_.i, i64 %sub.ptr.rhs.cast, i64 %1, ptr %el, ptr %end_capacity_.i.i.i) {
bb:
  %.pre711 = load ptr, ptr %el, align 8, !tbaa !37
  %.pre730 = ptrtoint ptr %.pre711 to i64
  %.pre709 = load ptr, ptr %end_size_.i, align 8, !tbaa !39
...
define i64 @"111"(i64 %lsum.035, ptr %arrayidx.i31, ptr %local_sums, ptr %.omp.lb) {
bb:
...
bb:
  %2 = load i64, ptr %shared_out_end.i, align 8, !tbaa !74
  %3 = load ptr, ptr %queue, align 8, !tbaa !66
  %add.ptr.i55 = getelementptr inbounds i32, ptr %3, i64 %2
  %sub.ptr.lhs.cast = ptrtoint ptr %add.ptr.i55 to i64
  %4 = load i64, ptr %shared_out_start.i, align 8, !tbaa !68
...
define i32 @"113"(ptr %call171, ptr %arrayidx.i542, ptr %arrayidx.i540, ptr %arrayidx.i541, i64 %0, i64 %1, i64 %total_missing_inv.1659) {
bb:
  %2 = load i64, ptr %arrayidx.i542, align 8, !tbaa !8
  %3 = load i32, ptr %arrayidx.i541, align 4, !tbaa !10
  %conv198 = sext i32 %3 to i64
...
define i64 @"114"(ptr %end_size_.i, ptr %degrees, i64 %0, i64 %1, i64 %2, ptr %num_blocks) {
bb:
  %3 = load ptr, ptr %end_size_.i, align 8, !tbaa !5
  %sub.ptr.lhs.cast.i = ptrtoint ptr %3 to i64
  %4 = load ptr, ptr %degrees, align 8, !tbaa !0
...
define i64 @"115"(ptr %arrayidx, ptr %new_range, ptr %.omp.lb) {
bb:
...
define i32 @"116"(ptr %n_start.0.in, i64 %0) {
bb:
  %n_start.0 = load ptr, ptr %n_start.0.in, align 8, !tbaa !16
  %incdec.ptr12.i.i.i.i = getelementptr inbounds i32, ptr %n_start.0, i64 %0
...
define ptr @"117"(ptr %new_range.i.i457, ptr %0, ptr %el, i64 %1, i64 %sub.ptr.rhs.cast, i64 %2, ptr %end_size_.i) {
bb:
  %3 = load ptr, ptr %new_range.i.i457, align 8, !tbaa !16
  %.pre711 = load ptr, ptr %el, align 8, !tbaa !37
  %.pre730 = ptrtoint ptr %.pre711 to i64
...
define i64 @"118"(ptr %num_edges_, i64 %0, i64 %1, i64 %2, ptr %.omp.ub) {
bb:
  %3 = load i64, ptr %num_edges_, align 8, !tbaa !75
...
define i32 @"119"(ptr %start_vertex_.i, ptr %sp) {
bb:
  %0 = load i64, ptr %start_vertex_.i, align 8, !tbaa !77
  %conv = trunc i64 %0 to i32
  store i32 %conv, ptr %sp, align 8, !tbaa !78
  ret i32 %conv
}
...
define i8 @"121"(ptr %0, ptr %opt_arg) {
bb:
...
define i64 @"123"(ptr %v, i32 %0, i64 %1, i64 %agg.tmp93.sroa.0.0.insert.ext, ptr %new_range.i.i, ptr %end_size_.i.i, ptr %agg.result, i64 %2) {
bb:
  ...
  %6 = load i32, ptr %v, align 4, !tbaa !50
  %sub = add nsw i32 %6, %0
  %agg.tmp.sroa.2.0.insert.ext = zext i32 %sub to i64
  %agg.tmp.sroa.2.0.insert.shift = shl nuw i64 %agg.tmp.sroa.2.0.insert.ext, %1
  %agg.tmp.sroa.0.0.insert.insert = or i64 %agg.tmp.sroa.2.0.insert.shift, %agg.tmp93.sroa.0.0.insert.ext
  store i64 %agg.tmp.sroa.0.0.insert.insert, ptr %add.ptr.i.i149, align 4, !tbaa.struct !52
  ret i64 %agg.tmp.sroa.0.0.insert.insert
}

define i32 @"124"(ptr %call171, ptr %arrayidx.i547, ptr %arrayidx.i546) {
bb:
...
define i64 @"125"(ptr %offsets, ptr %.omp.lb, i64 %0) {
bb:
  %1 = load i32, ptr %.omp.lb, align 4, !tbaa !10
  %2 = sext i32 %1 to i64
...
define ptr @"127"(ptr %new_range.i.i457, ptr %0, ptr %end_size_.i, i64 %sub.ptr.rhs.cast, i64 %1, ptr %el) {
bb:
  %2 = load ptr, ptr %new_range.i.i457, align 8, !tbaa !16
  %.pre711 = load ptr, ptr %el, align 8, !tbaa !37
  %.pre730 = ptrtoint ptr %.pre711 to i64
...
define i32 @"129"(ptr %el, ptr %.omp.lb, i64 %0, i64 %1, i64 %2) {
bb:
  %3 = load i64, ptr %.omp.lb, align 8, !tbaa !8
  %4 = sub i64 %0, %3
  %n.vec = and i64 %4, %1
...
define i64 @"130"(ptr %arrayidx.i208, i64 %0, i64 %1, i64 %2, i64 %3, i64 %xor.i211, i64 %4, i64 %5, i64 %xor4.i214, i64 %6, i64 %xor7.i217, ptr %num_nodes_, i64 %7, ptr %arrayidx.i72, i64 %xor.i75, i64 %xor4.i78, i64 %xor7.i81, i32 %8, ptr %el, ptr %.omp.lb) {
bb:
  ...
  %13 = load i64, ptr %num_nodes_, align 8, !tbaa !81
...
define i32 @"131"(ptr %e.sroa.5.0..sroa_idx, ptr %0, ptr %offsets, ptr %add.ptr, i64 %1) {
bb:
  %e.sroa.0.0.copyload = load i32, ptr %add.ptr, align 4, !tbaa.struct !52
  ...
  %e.sroa.5.0.copyload = load i32, ptr %e.sroa.5.0..sroa_idx, align 4, !tbaa.struct !53
  store i32 %e.sroa.5.0.copyload, ptr %arrayidx, align 4, !tbaa !10
  ret i32 %e.sroa.5.0.copyload
}

define i64 @"132"(ptr %offsets, ptr %num_nodes_.i, i32 %0) {
bb:
...
define i64 @"133"(ptr %_M_string_length.i.i.i, i64 %call, ptr %__dnew.i.i.i) {
bb:
  %0 = load i64, ptr %_M_string_length.i.i.i, align 8, !tbaa !45, !noalias !82
  %sub.i.i.i = sub i64 %0, %call
  store i64 %sub.i.i.i, ptr %__dnew.i.i.i, align 8, !tbaa !8, !noalias !82
  ret i64 %sub.i.i.i
}

define i64 @"134"(ptr %offsets, ptr %num_nodes_.i, i64 %0) {
bb:
  %1 = load ptr, ptr %offsets, align 8, !tbaa !6
  %2 = load i64, ptr %num_nodes_.i, align 8, !tbaa !42
  %sext = shl i64 %2, %0
...
define i64 @"135"(ptr %el, i64 %0, i64 %1) {
bb:
  %.pre = load ptr, ptr %el, align 8, !tbaa !37
  %incdec.ptr13.i.i.i.i = getelementptr inbounds %struct.EdgePair, ptr %.pre, i64 %0
  %__first.addr.030.i.i = getelementptr inbounds %struct.EdgePair, ptr %incdec.ptr13.i.i.i.i, i64 %1
...
define i32 @"136"(ptr %call171, ptr %arrayidx.i548, ptr %arrayidx.i549, ptr %arrayidx.i550, i64 %sub.ptr.rhs.cast.i.i.i.i552, i64 %0, i64 %1) {
bb:
...
define i32 @"141"(ptr %__first, ptr %add.ptr.i.i.i.i, ptr %add.ptr2.i.i.i.i, i64 %sub1.i.i.i.i, i64 %mul.i.i.i.i) {
bb:
  %0 = load i32, ptr %add.ptr.i.i.i.i, align 4, !tbaa !10
  %1 = load i32, ptr %add.ptr2.i.i.i.i, align 4, !tbaa !10
  %cmp.i.i.i.i.i = icmp slt i32 %0, %1
...
define <2 x i64> @"142"(ptr %0, <2 x i64> %1, <2 x i64> %2, <2 x i64> %3, ptr %4, <2 x i64> %5, <2 x i64> %6, ptr %7) {
bb:
...
define i64 @"143"(ptr %__first.addr.033.i.i, ptr %new_range.i.i, i64 %0) {
bb:
  %agg.tmp.sroa.0.0.copyload.i.i.i = load i64, ptr %__first.addr.033.i.i, align 4
  %.pre.i.i = load ptr, ptr %new_range.i.i, align 8, !tbaa !16
  %incdec.ptr13.i.i.i.i = getelementptr inbounds %struct.EdgePair, ptr %.pre.i.i, i64 %0
...
define i8 @"144"(i8 %0, ptr %ref.tmp, ptr %__dnew.i.i.i) {
bb:
  %1 = load i64, ptr %__dnew.i.i.i, align 8, !tbaa !8, !noalias !71
  %2 = load ptr, ptr %ref.tmp, align 8, !tbaa !35, !alias.scope !71
  %arrayidx.i.i.i.i = getelementptr inbounds i8, ptr %2, i64 %1
  store i8 %0, ptr %arrayidx.i.i.i.i, align 1, !tbaa !22
  ret i8 %0
}

define i32 @"145"(ptr %__first, ptr %add.ptr.i, ptr %add.ptr2.i, i64 %sub1.i, i64 %mul.i, i64 %0, i64 %1) {
bb:
...
define i64 @"146"(ptr %scout_count13, i32 %0, ptr %arrayidx.i60) {
bb:
...
define i64 @"147"(ptr %arrayidx.i25, i64 %0, ptr %arrayidx.i23, ptr %el, ptr %.omp.lb) {
bb:
  %1 = load i64, ptr %.omp.lb, align 8, !tbaa !8
  %2 = load ptr, ptr %el, align 8, !tbaa !37
...
bb:
  %1 = load i64, ptr %num_nodes_.i, align 8, !tbaa !42
  %2 = and i64 %1, %0
...
define ptr @"149"(ptr %el, ptr %0, i64 %1, i64 %sub.ptr.rhs.cast, i64 %2, ptr %end_size_.i) {
bb:
  %.pre = load ptr, ptr %el, align 8, !tbaa !37
  %.pre711 = load ptr, ptr %el, align 8, !tbaa !37
  %.pre730 = ptrtoint ptr %.pre711 to i64
...
define i64 @"150"(ptr %_M_p.i.i.i, i64 %0) {
bb:
  %1 = load i64, ptr %_M_p.i.i.i, align 8, !tbaa !48
  %inc.i71 = add nuw nsw i64 %1, %0
  %inc.i207 = add nuw nsw i64 %inc.i71, %0
  store i64 %inc.i207, ptr %_M_p.i.i.i, align 8, !tbaa !48
  ret i64 %inc.i207
}

define i32 @"151"(ptr %end_size_.i.i583, ptr %offsets, i64 %0, ptr %length.i581) {
bb:
  %1 = load ptr, ptr %offsets, align 8, !tbaa !6
  %sub.ptr.rhs.cast.i.i585 = ptrtoint ptr %1 to i64
  %2 = load ptr, ptr %end_size_.i.i583, align 8, !tbaa !54
...
define <2 x i32> @"152"(ptr %degrees, ptr %.omp.lb, i64 %0, i64 %index, i64 %1) {
bb:
  %2 = load i64, ptr %.omp.lb, align 8, !tbaa !8
  %mul12 = shl i64 %2, %0
  %offset.idx = add i64 %mul12, %index
...
define ptr @"153"(ptr %call.i, ptr %num_nodes_.i, ptr %end_size_.i) {
bb:
  %0 = load i64, ptr %num_nodes_.i, align 8, !tbaa !55
  %add.ptr.i = getelementptr inbounds i32, ptr %call.i, i64 %0
  store ptr %add.ptr.i, ptr %end_size_.i, align 8, !tbaa !5
  ret ptr %add.ptr.i
}

define i64 @"154"(ptr %.omp.lb, i64 %0, i64 %1, i64 %2, i64 %3, i64 %4, i64 %__i.018.i, i64 %add.i, i64 %inc.i, ptr %arrayidx7.i.1) {
bb:
  %5 = load i64, ptr %.omp.lb, align 8, !tbaa !8
  %add10 = add i64 %5, %0
  %rem.i.i.i = and i64 %add10, %1
...
define ptr @"155"(ptr %new_range.i.i, ptr %end_size_.i.i, ptr %agg.result, i64 %0) {
bb:
...
define ptr @"156"(ptr %new_range.i.i, ptr %end_capacity_.i.i, ptr %agg.result, i64 %0) {
bb:
  %1 = load ptr, ptr %agg.result, align 8, !tbaa !37
  %sub.ptr.rhs.cast.i.i = ptrtoint ptr %1 to i64
  %2 = load ptr, ptr %end_capacity_.i.i, align 8, !tbaa !44
  ...
  store ptr %add.ptr6.i.i, ptr %end_capacity_.i.i, align 8, !tbaa !44
  ret ptr %add.ptr6.i.i
}
...
define <8 x i32> @"158"(ptr %el, ptr %.omp.lb, i64 %index) {
bb:
  %0 = load i64, ptr %.omp.lb, align 8, !tbaa !8
...
define ptr @"159"(ptr %_ZSt4cout, ptr %vbase.offset.ptr.i, i64 %0, i32 %1) {
bb:
  %vbase.offset.i = load i64, ptr %vbase.offset.ptr.i, align 8
  %add.ptr.i = getelementptr inbounds i8, ptr %_ZSt4cout, i64 %vbase.offset.i
  %_M_ctype.i.i = getelementptr inbounds %"class.std::basic_ios", ptr %add.ptr.i, i64 %0, i32 5
  %2 = load ptr, ptr %_M_ctype.i.i, align 8, !tbaa !85
  ret ptr %2
}

define ptr @"160"(ptr %_M_finish.i.i, i64 %0, i32 %1) {
bb:
...
define i32 @"161"(ptr %el, ptr %.omp.lb, i64 %0, i64 %1) {
bb:
  %2 = load i64, ptr %.omp.lb, align 8, !tbaa !8
  %3 = sub i64 %0, %2
  %n.vec = and i64 %3, %1
...
define i64 @"162"(i64 %local_total.039, ptr %arrayidx.i35, ptr %prefix, ptr %.omp.lb, i64 %0) {
bb:
  %1 = load i64, ptr %.omp.lb, align 8, !tbaa !8
  %mul14 = shl i64 %1, %0
  %2 = load ptr, ptr %prefix, align 8
...
define ptr @"163"(ptr %out_index_.i, ptr %add.ptr) {
bb:
  %0 = load ptr, ptr %out_index_.i, align 8, !tbaa !92, !noalias !93
...
define ptr @"164"(ptr %neighs, ptr %arrayidx.i, ptr %index, ptr %.omp.lb) {
bb:
  %0 = load ptr, ptr %neighs, align 8, !tbaa !16
...
define i8 @"165"(ptr %arrayidx17.i.i, ptr %ref.tmp, i64 %conv5.i) {
bb:
  %0 = load ptr, ptr %ref.tmp, align 8, !tbaa !35, !alias.scope !96
...
define i32 @"166"(ptr %call171, ptr %arrayidx.i542, i64 %0, i64 %total_missing_inv.0649, ptr %arrayidx.i536) {
bb:
  %1 = load i64, ptr %arrayidx.i542, align 8, !tbaa !8
  %i200.0 = add nsw i64 %1, %0
...
define i64 @"167"(ptr %arrayidx.i535, i64 %total_missing_inv.0649, ptr %arrayidx.i536, ptr %offsets, i64 %indvars.iv691) {
bb:
...
define ptr @"168"(ptr %new_range.i.i, ptr %el, i64 %0, i64 %1, ptr %end_capacity_.i.i.i) {
bb:
  %.pre = load ptr, ptr %el, align 8, !tbaa !37
  %sub.ptr.rhs.cast = ptrtoint ptr %.pre to i64
  %incdec.ptr7.i.i = getelementptr inbounds %struct.EdgePair, ptr %.pre, i64 %0
...
define i64 @"169"(ptr %_M_p.i, i64 %0, ptr %udist_, i64 %1, i32 %2) {
bb:
  %.pre = load i64, ptr %_M_p.i, align 8, !tbaa !99
  %inc.i = add nuw nsw i64 %.pre, %0
  %3 = load ptr, ptr %udist_, align 8, !tbaa !46
  %_M_p.i2 = getelementptr inbounds %"class.std::mersenne_twister_engine", ptr %3, i64 %1, i32 1
  store i64 %inc.i, ptr %_M_p.i, align 8, !tbaa !99
  ret i64 %inc.i
}

define i32 @"170"(ptr %arrayidx212, ptr %call171, i64 %tail_index.0660, ptr %arrayidx.i542, ptr %arrayidx.i540, ptr %arrayidx.i541, i64 %0) {
bb:
...
define i32 @"171"(ptr %el, i64 %0, i32 %1) {
bb:
  %.pre = load ptr, ptr %el, align 8, !tbaa !37
...
define i8 @"172"(ptr %_M_ctype.i.i428, i64 %0, i32 %1, i64 %2) {
bb:
  %3 = load ptr, ptr %_M_ctype.i.i428, align 8, !tbaa !85
...
define <2 x i64> @"174"(ptr %0, ptr %offsets, ptr %num_nodes_.i, i64 %1, i64 %index770, i64 %2) {
bb:
...
define ptr @"175"(ptr %new_range.i.i, ptr %end_size_.i, ptr %el, i64 %0, ptr %end_capacity_.i.i.i) {
bb:
  %.pre = load ptr, ptr %el, align 8, !tbaa !37
  %sub.ptr.rhs.cast = ptrtoint ptr %.pre to i64
  %.pre709 = load ptr, ptr %end_size_.i, align 8, !tbaa !39
...
define ptr @"176"(ptr %call.i5155, ptr %end_size_.i, ptr %degrees, i64 %0, i64 %1, ptr %end_size_.i53) {
bb:
  %2 = load ptr, ptr %degrees, align 8, !tbaa !0
...
define ptr @"177"(ptr %new_range.i.i, ptr %el, i64 %0, i64 %1, ptr %end_capacity_.i.i.i) {
bb:
  %.pre = load ptr, ptr %el, align 8, !tbaa !37
  %sub.ptr.rhs.cast = ptrtoint ptr %.pre to i64
  %incdec.ptr7.i.i = getelementptr inbounds %struct.EdgePair, ptr %.pre, i64 %0
...
define i64 @"178"(ptr %end_size_, ptr %this, i64 %0, i64 %1, ptr %.omp.ub) {
bb:
...
define ptr @"179"(ptr %in_index_.i, ptr %.omp.lb, i64 %0) {
bb:
...
define ptr @"180"(ptr %out_index_.i, ptr %add.ptr, i32 %0) {
bb:
  %1 = load i32, ptr %add.ptr, align 4, !tbaa !10
...
define i32 @"181"(ptr %init_val, ptr %this, ptr %.omp.lb, i64 %0) {
bb:
...
define i64 @"182"(ptr %arrayidx3.i.i91, i64 %0, ptr %1, i64 %2, i64 %3, ptr %arrayidx7.i.i95, i64 %4, i64 %5, ptr %arrayidx.i.i88) {
bb:
...
define i64 @"183"(i32 %shl19, ptr %arrayidx.i61, i64 %0, i64 %1, i64 %2, i64 %3, i64 %xor.i63, i64 %4, i64 %5, i64 %xor4.i, i64 %6, i64 %xor7.i, i32 %7, i32 %8, i32 %9, i32 %conv, i64 %10, i64 %ref.tmp30.sroa.0.0.insert.ext, ptr %el, ptr %.omp.lb) {
bb:
...
define <2 x i64> @"184"(ptr %0, <2 x i64> %1, <2 x i64> %2, ptr %rng, i64 %3, <2 x i64> %4, <2 x i64> %5, ptr %6, <2 x i64> %7, <2 x i64> %8, ptr %9) {
bb:
...
define i64 @"185"(ptr %_ZSt4cout, i64 %0) {
bb:
  %vtable.i = load ptr, ptr %_ZSt4cout, align 8, !tbaa !100
  %vbase.offset.ptr.i = getelementptr i8, ptr %vtable.i, i64 %0
  %vbase.offset.i = load i64, ptr %vbase.offset.ptr.i, align 8
  ret i64 %vbase.offset.i
}

define i64 @"186"(ptr %awake_count7, i64 %0) {
bb:
  %1 = load i64, ptr %awake_count7, align 8, !tbaa !8, !llvm.access.group !36
  %inc = add nsw i64 %1, %0
  store i64 %inc, ptr %awake_count7, align 8, !tbaa !8, !llvm.access.group !36
  ret i64 %inc
}

define i32 @"187"(i64 %indvars.iv687, ptr %incdec.ptr4.sink.i.i.i.i, ptr %__first.addr.015.i.i, ptr %neighs, ptr %arrayidx.i524, i64 %sub.ptr.rhs.cast.i.i.i.i526, i64 %0, i64 %1) {
bb:
  %2 = load ptr, ptr %neighs, align 8, !tbaa !16
...
define i32 @"188"(i32 %0, ptr %call171, ptr %arrayidx.i548, i64 %1, ptr %arrayidx.i549) {
bb:
  %2 = load i64, ptr %arrayidx.i548, align 8, !tbaa !8
  %add286 = add i64 %2, %1
  %3 = load i32, ptr %arrayidx.i549, align 4, !tbaa !10
...
define i32 @"189"(ptr %el, ptr %.omp.lb, i64 %0, i64 %1) {
bb:
  %2 = load i64, ptr %.omp.lb, align 8, !tbaa !8
  %add15 = add i64 %2, %0
  %3 = load ptr, ptr %el, align 8, !tbaa !37
...
define ptr @"190"(ptr %transpose, i8 %0, ptr %out_index_.i, ptr %in_index_.i, ptr %.omp.lb) {
bb:
  %1 = load i32, ptr %.omp.lb, align 4, !tbaa !10
  %2 = sext i32 %1 to i64
...
define i32 @"191"(ptr %init_val, ptr %this, ptr %.omp.lb, i64 %0, i64 %1) {
bb:
  %2 = load ptr, ptr %this, align 8, !tbaa !0
  %3 = load i64, ptr %.omp.lb, align 8, !tbaa !8
  %4 = sub i64 %0, %3
...
define i64 @"192"(ptr %num_nodes_.i, ptr %0) {
bb:
  %1 = load i64, ptr %num_nodes_.i, align 8, !tbaa !55, !noalias !57
  store i64 %1, ptr %0, align 8, !alias.scope !57
  ret i64 %1
}

define i64 @"193"(ptr %rng, i64 %0, ptr %_M_p.i.i.i, i64 %1) {
bb:
  %2 = load i64, ptr %_M_p.i.i.i, align 8, !tbaa !48
  %inc.i71 = add nuw nsw i64 %2, %1
...
define i32 @"194"(ptr %el, ptr %.omp.lb, i64 %0) {
bb:
  %1 = load i64, ptr %.omp.lb, align 8, !tbaa !8
  %add15 = add i64 %1, %0
  %2 = load ptr, ptr %el, align 8, !tbaa !37
...
define ptr @"195"(ptr %out_index_.i, ptr %arrayidx.i7, i64 %0, i64 %1, i64 %2, i64 %3, i64 %xor.i, i64 %4, i64 %5, i64 %xor4.i, i64 %6, ptr %mod_.i, i32 %7) {
bb:
  ...
  %9 = load i32, ptr %mod_.i, align 4, !tbaa !102
  %rem.i = urem i32 %conv7.i, %9
  %add.i = add nsw i32 %rem.i, %7
  %idxprom.i = sext i32 %add.i to i64
  %10 = load ptr, ptr %out_index_.i, align 8, !tbaa !92
  %arrayidx.i = getelementptr inbounds ptr, ptr %10, i64 %idxprom.i
  %11 = load ptr, ptr %arrayidx.i, align 8, !tbaa !16
  ret ptr %11
}

define i64 @"196"(ptr %arrayidx.i.i, ptr %0, i64 %1, ptr %2) {
bb:
  %3 = load ptr, ptr %0, align 8, !tbaa !16, !noalias !57
  %sub.ptr.rhs.cast.i.i = ptrtoint ptr %3 to i64
  %4 = load ptr, ptr %arrayidx.i.i, align 8, !tbaa !16, !noalias !57
  %sub.ptr.lhs.cast.i.i = ptrtoint ptr %4 to i64
  %sub.ptr.sub.i.i = sub i64 %sub.ptr.lhs.cast.i.i, %sub.ptr.rhs.cast.i.i
  %sub.ptr.div.i.i = ashr exact i64 %sub.ptr.sub.i.i, %1
  store i64 %sub.ptr.div.i.i, ptr %2, align 8, !alias.scope !57
  ret i64 %sub.ptr.div.i.i
}

define i64 @"197"(ptr %rng, i64 %0, ptr %_M_p.i.i.i, i64 %1) {
bb:
  %2 = load i64, ptr %_M_p.i.i.i, align 8, !tbaa !48
  %inc.i71 = add nuw nsw i64 %2, %1
...
define i64 @"198"(ptr %offsets, ptr %num_nodes_.i, i64 %0) {
bb:
  %1 = load i64, ptr %num_nodes_.i, align 8, !tbaa !42
  %2 = and i64 %1, %0
  %sub = add nuw i64 %2, %0
...
define i64 @"200"(ptr %arrayidx.i58.3, ptr %arrayidx.i58.2, ptr %arrayidx.i58.1, ptr %arrayidx.i58, i64 %total.076, ptr %call.i4145, ptr %num_blocks) {
bb:
  %0 = load i64, ptr %num_blocks, align 8, !tbaa !8
  %arrayidx.i = getelementptr inbounds i64, ptr %call.i4145, i64 %0
...
define i32 @"201"(ptr %degrees, i64 %mul12, i64 %umin, ptr %.omp.lb, i64 %indvar, i64 %0, i64 %n.mod.vf) {
bb:
  %1 = load i64, ptr %.omp.lb, align 8, !tbaa !8
  %2 = add i64 %1, %indvar
  %3 = shl i64 %2, %0
...
define i32 @"202"(ptr %__begin3.064, ptr %parent, ptr %.omp.lb) {
bb:
  %0 = load ptr, ptr %parent, align 8, !tbaa !0, !llvm.access.group !36
  %1 = load i32, ptr %.omp.lb, align 4, !tbaa !10
  %2 = sext i32 %1 to i64
...
define i32 @"203"(ptr %add.ptr.i.i, ptr %__first, ptr %add.ptr.i, ptr %add.ptr2.i, i64 %sub1.i, i64 %mul.i) {
bb:
...
define i64 @"204"(ptr %el) {
bb:
  %.pre = load ptr, ptr %el, align 8, !tbaa !37
  %agg.tmp.sroa.0.0.copyload.i.i.i.i.i = load i64, ptr %.pre, align 4, !tbaa.struct !52
  ret i64 %agg.tmp.sroa.0.0.copyload.i.i.i.i.i
}

define i64 @"205"(ptr %_M_string_length.i.i.i, ptr %__dnew.i.i.i) {
bb:
  %0 = load i64, ptr %_M_string_length.i.i.i, align 8, !tbaa !45, !noalias !71
  store i64 %0, ptr %__dnew.i.i.i, align 8, !tbaa !8, !noalias !71
  ret i64 %0
}

define i32 @"206"(ptr %arrayidx.i, ptr %arrayidx4.i.phi.trans.insert, i32 %0, i32 %1, i64 %sub.ptr.rhs.cast.i, i64 %2, ptr %parent, ptr %.omp.lb) {
bb:
...
define i32 @"207"(ptr %neighs, ptr %arrayidx.i523, ptr %arrayidx.i524, i64 %sub.ptr.rhs.cast.i.i.i.i526, i64 %0, i64 %1) {
bb:
  %2 = load ptr, ptr %neighs, align 8, !tbaa !16
  %3 = load i64, ptr %arrayidx.i524, align 8, !tbaa !8
  %add.ptr121 = getelementptr inbounds i32, ptr %2, i64 %3
...
define ptr @"208"(ptr %el, ptr %end_size_.i, i64 %sub.ptr.rhs.cast, i64 %0) {
bb:
  %.pre709 = load ptr, ptr %end_size_.i, align 8, !tbaa !39
  %sub.ptr.lhs.cast = ptrtoint ptr %.pre709 to i64
  %sub.ptr.sub = sub i64 %sub.ptr.lhs.cast, %sub.ptr.rhs.cast
...
define i64 @"209"(ptr %rng, i64 %0, ptr %arrayidx42.i.i124, i64 %1, i64 %2, ptr %arrayidx49.i.i128, i64 %3, i64 %4) {
bb:
...
define i64 @"210"(i64 %0, ptr %offsets, ptr %num_nodes_.i, i64 %1) {
bb:
  %2 = load i64, ptr %num_nodes_.i, align 8, !tbaa !42
  %3 = and i64 %2, %1
...
define i64 @"211"(ptr %0, ptr %1, ptr %2) {
bb:
...
define ptr @"212"(ptr %call.i132133, ptr %num_nodes, i64 %0, ptr %end_size_.i) {
bb:
  %1 = load i64, ptr %num_nodes, align 8, !tbaa !8
  %add = add nsw i64 %1, %0
...
define <2 x i64> @"213"(ptr %__first, <2 x i64> %0) {
bb:
...
define i64 @"214"(ptr %offsets, ptr %.omp.lb) {
bb:
...
define <2 x i64> @"215"(ptr %offsets, ptr %num_nodes_.i, i64 %0, i64 %index770, i64 %1) {
bb:
  %2 = load ptr, ptr %offsets, align 8
  %3 = load i64, ptr %num_nodes_.i, align 8, !tbaa !42
  %4 = and i64 %3, %0
...
define <4 x i32> @"216"(ptr %0, ptr %call171, ptr %arrayidx.i539, i64 %1, i64 %index800, i64 %2) {
bb:
...
define ptr @"218"(ptr %out_index_.i, ptr %arrayidx.i7, i64 %0, i64 %1, i64 %2, i64 %3, i64 %xor.i, i64 %4, i64 %5, i64 %xor4.i, i64 %6, ptr %mod_.i) {
bb:
  ...
  %xor9.i = xor i64 %shr8.i, %xor4.i
  %conv7.i = trunc i64 %xor9.i to i32
  %8 = load i32, ptr %mod_.i, align 4, !tbaa !102
  %rem.i = urem i32 %conv7.i, %8
  %idxprom3.i = sext i32 %rem.i to i64
  %9 = load ptr, ptr %out_index_.i, align 8, !tbaa !92
  %arrayidx4.i = getelementptr inbounds ptr, ptr %9, i64 %idxprom3.i
  %10 = load ptr, ptr %arrayidx4.i, align 8, !tbaa !16
  ret ptr %10
}

define i64 @"219"(ptr %arrayidx.i533, i64 %total_missing_inv.0649, ptr %arrayidx.i536, ptr %offsets, ptr %num_nodes_.i) {
bb:
  %.pre716.pre727 = load ptr, ptr %offsets, align 8, !tbaa !6
  %0 = load i64, ptr %num_nodes_.i, align 8, !tbaa !42
...
define i32 @"220"(i32 %0, ptr %parent, ptr %.omp.lb) {
bb:
  %1 = load i32, ptr %.omp.lb, align 4, !tbaa !10
  %2 = sext i32 %1 to i64
...
define i64 @"221"(ptr %_M_b.i, ptr %__param, i64 %0, ptr %_M_b.i32) {
bb:
  %1 = load i64, ptr %__param, align 8, !tbaa !103
  %2 = load i64, ptr %_M_b.i, align 8, !tbaa !105
  %sub = sub i64 %2, %1
  %div31 = lshr i64 %sub, %0
  store i64 %div31, ptr %_M_b.i32, align 8, !tbaa !105
  ret i64 %div31
}

define i64 @"222"(ptr %__first, ptr %add.ptr.i.i.i, ptr %add.ptr2.i.i.i, ptr %v.i.i.i.i.i, ptr %v3.i.i.i.i.i, i64 %sub1.i.i.i, i64 %mul.i.i.i) {
bb:
...
define i64 @"223"(ptr %add.ptr3.i.i.i, ptr %__first, ptr %add.ptr.i.i.i, ptr %add.ptr2.i.i.i, ptr %v.i.i.i.i.i, ptr %v3.i.i.i.i.i, i64 %sub1.i.i.i, i64 %mul.i.i.i) {
bb:
  %0 = load i32, ptr %add.ptr.i.i.i, align 4, !tbaa !40
  %1 = load i32, ptr %add.ptr2.i.i.i, align 4, !tbaa !40
  %cmp.i.i.i.i.i = icmp eq i32 %0, %1
...
define i64 @"224"(ptr %arrayidx.i58.3, ptr %arrayidx.i58.2, ptr %arrayidx.i58.1, ptr %arrayidx.i58, i64 %total.076, ptr %arrayidx.i57.epil) {
bb:
  %0 = load i64, ptr %arrayidx.i58.3, align 8, !tbaa !8
  %1 = load i64, ptr %arrayidx.i58.2, align 8, !tbaa !8
  %2 = load i64, ptr %arrayidx.i58, align 8, !tbaa !8
...
define i8 @"225"(ptr %arrayidx.i17.i, ptr %ref.tmp, i64 %conv5.i, i64 %idxprom1.i.i) {
bb:
  %0 = load ptr, ptr %ref.tmp, align 8, !tbaa !35, !alias.scope !96
  %arrayidx.i.i = getelementptr inbounds i8, ptr %0, i64 %conv5.i
  %arrayidx2.i.i = getelementptr inbounds i8, ptr %arrayidx.i.i, i64 %idxprom1.i.i
...
bb:
  %.pre = load ptr, ptr %el, align 8, !tbaa !37
  %incdec.ptr13.i.i.i.i = getelementptr inbounds %struct.EdgePair, ptr %.pre, i64 %0
  %agg.tmp.sroa.0.0.copyload.i78.i.i.i.i = load i64, ptr %incdec.ptr13.i.i.i.i, align 4, !tbaa.struct !52
  ret i64 %agg.tmp.sroa.0.0.copyload.i78.i.i.i.i
}

define i64 @"227"(ptr %_M_p.i.i.i, i64 %0) {
bb:
  %1 = load i64, ptr %_M_p.i.i.i, align 8, !tbaa !48
  %inc.i71 = add nuw nsw i64 %1, %0
  store i64 %inc.i71, ptr %_M_p.i.i.i, align 8, !tbaa !48
  ret i64 %inc.i71
}

define ptr @"228"(ptr %new_range.i.i, ptr %0, ptr %end_size_.i, i64 %sub.ptr.rhs.cast, i64 %1, ptr %el) {
bb:
  %.pre.i.i = load ptr, ptr %new_range.i.i, align 8, !tbaa !16
  %.pre711 = load ptr, ptr %el, align 8, !tbaa !37
  %.pre730 = ptrtoint ptr %.pre711 to i64
...
define ptr @"229"(ptr %call.i239240, ptr %num_nodes_.i, i64 %0, i64 %1, ptr %end_.i) {
bb:
  ...
  store ptr %add.ptr.i, ptr %end_.i, align 8, !tbaa !106
  ret ptr %add.ptr.i
}

define i32 @"230"(ptr %num_nodes_.i.i, i32 %0, i64 %1, i64 %2, i32 %3, i32 %conv14.i.i, ptr %4) {
bb:
  %5 = load i64, ptr %num_nodes_.i.i, align 8, !tbaa !55
...
define i64 @"231"(ptr %next, ptr %.omp.lb, i64 %0) {
bb:
  %1 = load i32, ptr %.omp.lb, align 4, !tbaa !10
  %2 = sext i32 %1 to i64
...
!42 = !{!43, !9, i64 16}
!43 = !{!"_ZTS11BuilderBaseIiiiLb1EE", !2, i64 0, !13, i64 8, !13, i64 9, !13, i64 10, !9, i64 16}
!44 = !{!38, !2, i64 16}
!45 = !{!29, !9, i64 8}
!46 = !{!47, !2, i64 0}
!47 = !{!"_ZTS7UniDistIiSt23mersenne_twister_engineImLm64ELm312ELm156ELm31ELm13043109905998158313ELm29ELm6148914691236517205ELm17ELm8202884508482404352ELm37ELm18444473444759240704ELm43ELm6364136223846793005EEjE", !2, i64 0, !13, i64 8, !11, i64 12, !11, i64 16}
!48 = !{!49, !9, i64 4992}
!49 = !{!"_ZTSSt23mersenne_twister_engineImLm32ELm624ELm397ELm31ELm2567483615ELm11ELm4294967295ELm7ELm2636928640ELm15ELm4022730752ELm18ELm1812433253EE", !3, i64 0, !9, i64 4992}
!50 = !{!51, !11, i64 0}
!51 = !{!"_ZTS10NodeWeightIiiE", !11, i64 0, !11, i64 4}
!52 = !{i64 0, i64 4, !10, i64 4, i64 4, !10}
!53 = !{i64 0, i64 4, !10}
!54 = !{!7, !2, i64 8}
!55 = !{!56, !9, i64 8}
!56 = !{!"_ZTS8CSRGraphIiiLb1EE", !13, i64 0, !9, i64 8, !9, i64 16, !2, i64 24, !2, i64 32, !2, i64 40, !2, i64 48}
!57 = !{!58}
!58 = distinct !{!58, !59, !"_ZN11BuilderBaseIiiiLb1EE11SquishGraphERK8CSRGraphIiiLb1EE: %agg.result"}
!59 = distinct !{!59, !"_ZN11BuilderBaseIiiiLb1EE11SquishGraphERK8CSRGraphIiiLb1EE"}
!60 = !{!61}
!61 = distinct !{!61, !62, !"_ZSt19__relocate_object_aINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEES5_SaIS5_EEvPT_PT0_RT1_: %__orig"}
!62 = distinct !{!62, !"_ZSt19__relocate_object_aINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEES5_SaIS5_EEvPT_PT0_RT1_"}
!63 = !{!64}
!64 = distinct !{!64, !62, !"_ZSt19__relocate_object_aINSt7__cxx1112basic_stringIcSt11char_traitsIcESaIcEEES5_SaIS5_EEvPT_PT0_RT1_: %__dest"}
!65 = !{!30, !2, i64 0}
!66 = !{!67, !2, i64 0}
!67 = !{!"_ZTS12SlidingQueueIiE", !2, i64 0, !9, i64 8, !9, i64 16, !9, i64 24}
!68 = !{!67, !9, i64 16}
!69 = !{!34, !2, i64 8}
!70 = !{!34, !2, i64 16}
!71 = !{!72}
...
!74 = !{!67, !9, i64 24}
!75 = !{!76, !9, i64 16}
!76 = !{!"_ZTS9GeneratorIiiijLi32ESt23mersenne_twister_engineImLm32ELm624ELm397ELm31ELm2567483615ELm11ELm4294967295ELm7ELm2636928640ELm15ELm4022730752ELm18ELm1812433253EEE", !11, i64 0, !9, i64 8, !9, i64 16}
!77 = !{!27, !9, i64 160}
!78 = !{!79, !11, i64 0}
!79 = !{!"_ZTS12SourcePickerI8CSRGraphIiiLb1EEE", !11, i64 0, !80, i64 8, !47, i64 2512, !2, i64 2536}
!80 = !{!"_ZTSSt23mersenne_twister_engineImLm64ELm312ELm156ELm31ELm13043109905998158313ELm29ELm6148914691236517205ELm17ELm8202884508482404352ELm37ELm18444473444759240704ELm43ELm6364136223846793005EE", !3, i64 0, !9, i64 2496}
!81 = !{!76, !9, i64 8}
!82 = !{!83}
...
!85 = !{!86, !2, i64 240}
!86 = !{!"_ZTSSt9basic_iosIcSt11char_traitsIcEE", !87, i64 0, !2, i64 216, !3, i64 224, !13, i64 225, !2, i64 232, !2, i64 240, !2, i64 248, !2, i64 256}
!87 = !{!"_ZTSSt8ios_base", !9, i64 8, !9, i64 16, !88, i64 24, !89, i64 28, !89, i64 32, !2, i64 40, !90, i64 48, !3, i64 64, !11, i64 192, !2, i64 200, !91, i64 208}
!88 = !{!"_ZTSSt13_Ios_Fmtflags", !3, i64 0}
!89 = !{!"_ZTSSt12_Ios_Iostate", !3, i64 0}
!90 = !{!"_ZTSNSt8ios_base6_WordsE", !2, i64 0, !9, i64 8}
!91 = !{!"_ZTSSt6locale", !2, i64 0}
!92 = !{!56, !2, i64 24}
!93 = !{!94}
...
!99 = !{!80, !9, i64 2496}
!100 = !{!101, !101, i64 0}
!101 = !{!"vtable pointer", !4, i64 0}
!102 = !{!47, !11, i64 12}
!103 = !{!104, !9, i64 0}
!104 = !{!"_ZTSNSt24uniform_int_distributionImE10param_typeE", !9, i64 0, !9, i64 8}
!105 = !{!104, !9, i64 8}
!106 = !{!107, !2, i64 8}
!107 = !{!"_ZTS6Bitmap", !2, i64 0, !2, i64 8}
