...
define i64 @"28"(ptr %arrayidx.i56, ptr %arrayidx.i56.3, ptr %arrayidx.i56.2, ptr %arrayidx.i56.1, i64 %add7, ptr %arrayidx.i55.1) {
bb:
...
define ptr @"43"(ptr %__p.044, ptr %retval.0.i, ptr %add.ptr, i64 %__bkt_count) {
bb:
...
define ptr @"45"(ptr %call.i, ptr %end_size_.i, ptr %degrees, i64 %0, i64 %1, i64 %2, ptr %end_size_.i38) {
bb:
...
define i64 @"53"(ptr %arrayidx.i263, i64 %0, ptr %label_source_pair.sroa.5.0.call42.sroa_idx, i64 %1) {
bb:
...
define i64 @"55"(ptr %arrayidx.i56.epil, i64 %total.074.epil, ptr %arrayidx.i55.epil) {
bb:
...
define ptr @"57"(ptr %el, i64 %0, i64 %sub.ptr.rhs.cast, i64 %1, ptr %end_size_.i) {
bb:
  %.pre = load ptr, ptr %el, align 8, !tbaa !39
...
define i64 @"60"(ptr %arrayidx.i56.3, ptr %arrayidx.i56.2, ptr %arrayidx.i56.1, ptr %arrayidx.i56, i64 %total.074, ptr %arrayidx.i55) {
bb:
  %0 = load i64, ptr %arrayidx.i56, align 8, !tbaa !0
...
define i32 @"67"(ptr %comp, ptr %arrayidx.i36.phi.trans.insert) {
bb:
...
define i64 @"76"(ptr %el, i64 %0, i64 %1) {
bb:
  %.pre = load ptr, ptr %el, align 8, !tbaa !39
  %incdec.ptr13.i.i.i.i = getelementptr inbounds %struct.EdgePair, ptr %.pre, i64 %0
...
define ptr @"79"(ptr %el, ptr %0, i64 %1, i64 %sub.ptr.rhs.cast, i64 %2, ptr %end_size_.i) {
bb:
  %.pre = load ptr, ptr %el, align 8, !tbaa !39
  %incdec.ptr7.i.i = getelementptr inbounds %struct.EdgePair, ptr %.pre, i64 %1
  %sub.ptr.lhs.cast = ptrtoint ptr %incdec.ptr7.i.i to i64
...
define i64 @"81"(ptr %arrayidx.i492.1, ptr %offsets, ptr %num_nodes_.i, i64 %0, i64 %1) {
bb:
...
define i32 @"82"(ptr %neighs, ptr %arrayidx.i522) {
bb:
...
define i64 @"83"(ptr %_M_p.i.i.i, i64 %0) {
bb:
  %1 = load i64, ptr %_M_p.i.i.i, align 8, !tbaa !59
  %inc.i71 = add nuw nsw i64 %1, %0
...
define i64 @"84"(ptr %__begin0.sroa.0.060, i64 %0, ptr %cond.i31.i.i.i, ptr %_M_finish.i38, i64 %1, i64 %sub.ptr.rhs.cast.i, i64 %2) {
bb:
...
define i64 @"86"(ptr %arrayidx.i56.epil, i64 %total.074.epil, ptr %call.i3943, ptr %num_blocks) {
bb:
  %0 = load i64, ptr %arrayidx.i56.epil, align 8, !tbaa !0
  %add7.epil = add nsw i64 %0, %total.074.epil
...
define i32 @"87"(ptr %retval.1.i.i, i32 %0, ptr %1, i64 %2) {
bb:
...
define i64 @"91"(ptr %offsets, ptr %num_nodes_.i) {
bb:
...
define i32 @"92"(ptr %num_nodes_.i, i32 %0, ptr %.omp.ub) {
bb:
...
define i64 @"93"(ptr %rng, i64 %0, ptr %_M_p.i.i.i, i64 %1) {
bb:
...
define i64 @"94"(ptr %arrayidx.i18.i, ptr %0, i64 %1, ptr %2) {
bb:
...
define i64 @"95"(ptr %add.ptr.i.i.i.i16, ptr %__first, ptr %add.ptr.i.i.i, ptr %add.ptr2.i.i.i, ptr %v.i.i.i.i.i, ptr %v3.i.i.i.i.i, i64 %sub1.i.i.i, i64 %mul.i.i.i) {
bb:
...
define i32 @"96"(ptr %__first.addr.033.i.i, ptr %n_start.0.in, i64 %0) {
bb:
  %n_start.0 = load ptr, ptr %n_start.0.in, align 8, !tbaa !16
...
define i32 @"99"(ptr %neighs, ptr %arrayidx.i523) {
bb:
...
define i32 @"100"(ptr %n_start.0.in, i64 %0, i64 %1, ptr %diffs, ptr %.omp.lb) {
bb:
  %n_start.0 = load ptr, ptr %n_start.0.in, align 8, !tbaa !16
...
define i64 @"101"(ptr %__first.addr.07.i.i.i.i.i.i.i, ptr %cond.i31.i.i.i, ptr %_M_finish.i.i114, i64 %0, i64 %1, ptr %count_vector, i64 %2, i64 %3) {
bb:
  %4 = load i64, ptr %__first.addr.07.i.i.i.i.i.i.i, align 4, !alias.scope !73, !noalias !76
  %5 = load ptr, ptr %count_vector, align 8, !tbaa !16
  %6 = ptrtoint ptr %5 to i64
  ...
  store i64 %4, ptr %ind.end, align 4, !alias.scope !76, !noalias !73
  ret i64 %4
}

define ptr @"102"(ptr %new_range.i.i457, ptr %el, i64 %0, i64 %1, ptr %end_capacity_.i.i.i) {
bb:
  %.pre = load ptr, ptr %el, align 8, !tbaa !39
  %incdec.ptr13.i.i.i.i = getelementptr inbounds %struct.EdgePair, ptr %.pre, i64 %0
  %sub.ptr.lhs.cast11 = ptrtoint ptr %incdec.ptr13.i.i.i.i to i64
...
define ptr @"103"(ptr %cond.i31.i.i.i, i64 %.sroa.speculated.i.i.i.i, ptr %_M_finish.i.i114, i64 %0, ptr %count_vector, i64 %1, i64 %sub.ptr.div.i.i.i.i.i, i1 %cmp9.i.i.i.i, i64 %2, i64 %add.i.i.i.i, ptr %_M_end_of_storage.i.i277) {
bb:
  %3 = load ptr, ptr %count_vector, align 8, !tbaa !16
  %sub.ptr.rhs.cast.i.i.i.i.i = ptrtoint ptr %3 to i64
  %4 = load ptr, ptr %_M_finish.i.i114, align 8, !tbaa !37
...
define i32 @"104"(ptr %__first, ptr %add.ptr.i.i.i, ptr %add.ptr2.i.i.i, ptr %v.i.i.i.i.i, ptr %v3.i.i.i.i.i, i64 %sub1.i.i.i, i64 %mul.i.i.i, i64 %0, i64 %1) {
bb:
...
define ptr @"105"(ptr %cond.i31, i64 %.sroa.speculated.i, ptr %_M_finish.i.i, ptr %this, i64 %0, i64 %sub.ptr.div.i.i, i1 %cmp9.i, i64 %1, i64 %add.i, ptr %_M_end_of_storage) {
bb:
  %2 = load ptr, ptr %this, align 8, !tbaa !16
  %sub.ptr.rhs.cast.i.i = ptrtoint ptr %2 to i64
  %3 = load ptr, ptr %_M_finish.i.i, align 8, !tbaa !78
...
define i32 @"106"(ptr %__i.sroa.0.042.i.ptr, i64 %0, ptr %second.i.i.i.i.i) {
bb:
  ...
  store i32 %__val.sroa.4.0.extract.trunc.i, ptr %second.i.i.i.i.i, align 4, !tbaa !80
...
define ptr @"108"(ptr %el, i64 %0, i64 %sub.ptr.rhs.cast, i64 %1, ptr %end_size_.i) {
bb:
  %.pre = load ptr, ptr %el, align 8, !tbaa !39
  %incdec.ptr7.i.i = getelementptr inbounds %struct.EdgePair, ptr %.pre, i64 %0
  %sub.ptr.lhs.cast = ptrtoint ptr %incdec.ptr7.i.i to i64
...
define i32 @"109"(ptr %init_val, ptr %this, ptr %.omp.lb, i64 %0, i64 %1) {
bb:
  %2 = load i32, ptr %init_val, align 4, !tbaa !10
  %3 = load ptr, ptr %this, align 8, !tbaa !7
  %4 = load i64, ptr %.omp.lb, align 8, !tbaa !0
...
define i8 @"110"(ptr %label) {
bb:
  %0 = load ptr, ptr %label, align 8, !tbaa !35, !noalias !82
  %1 = load i8, ptr %0, align 1, !tbaa !22
  ret i8 %1
}

define ptr @"111"(ptr %__args, ptr %cond.i31, i64 %sub.ptr.lhs.cast.i, ptr %this, i64 %0) {
bb:
...
define i64 @"112"(ptr %incdec.ptr126.i.i, ptr %el, i64 %0) {
bb:
...
define ptr @"113"(ptr %index.i139, ptr %0) {
bb:
...
define i64 @"114"(ptr %arrayidx.i492.prol, ptr %offsets, ptr %num_nodes_.i, i64 %0) {
bb:
...
define i64 @"115"(ptr %arrayidx.i492, ptr %offsets, ptr %num_nodes_.i, i64 %0) {
bb:
...
define i64 @"116"(ptr %count_vector, ptr %_M_finish.i.i114, i64 %0, i64 %1, i64 %2, i64 %3) {
bb:
  ...
  %13 = load i64, ptr %ind.end280, align 4, !alias.scope !73, !noalias !76
  ret i64 %13
}

define ptr @"117"(ptr %new_range.i.i457, ptr %0, ptr %el, i64 %sub.ptr.rhs.cast, i64 %1, ptr %end_capacity_.i.i.i) {
bb:
  %2 = load ptr, ptr %el, align 8, !tbaa !39
  %sub.ptr.lhs.cast = ptrtoint ptr %2 to i64
  %sub.ptr.sub = sub i64 %sub.ptr.lhs.cast, %sub.ptr.rhs.cast
...
define i64 @"118"(i64 %lsum.034, ptr %arrayidx.i30, ptr %local_sums, ptr %.omp.lb) {
bb:
  %0 = load i64, ptr %.omp.lb, align 8, !tbaa !0
...
define i32 @"119"(ptr %call171, ptr %arrayidx.i542, ptr %arrayidx.i540, ptr %arrayidx.i541, i64 %0, i64 %1, i64 %total_missing_inv.1659) {
bb:
  %2 = load i64, ptr %arrayidx.i542, align 8, !tbaa !0
  %3 = load i64, ptr %arrayidx.i540, align 8, !tbaa !0
  %4 = load i32, ptr %arrayidx.i541, align 4, !tbaa !10
...
define <4 x i32> @"122"(ptr %gep, <4 x i32> %0, <2 x i32> %1, ptr %gep123) {
bb:
...
define i32 @"123"(ptr %n_start.0.in, i64 %0) {
bb:
  %n_start.0 = load ptr, ptr %n_start.0.in, align 8, !tbaa !16
  %incdec.ptr12.i.i.i.i = getelementptr inbounds i32, ptr %n_start.0, i64 %0
...
define ptr @"124"(ptr %new_range.i.i457, ptr %0, ptr %el, i64 %1, i64 %sub.ptr.rhs.cast, i64 %2, ptr %end_size_.i) {
bb:
  %.pre.i.i476 = load ptr, ptr %new_range.i.i457, align 8, !tbaa !16
  %.pre = load ptr, ptr %el, align 8, !tbaa !39
  %incdec.ptr7.i.i = getelementptr inbounds %struct.EdgePair, ptr %.pre, i64 %1
...
define i32 @"126"(ptr %__i.sroa.0.042.i.ptr, ptr %__first.coerce) {
bb:
  %0 = load i64, ptr %__i.sroa.0.042.i.ptr, align 4
  %__val.sroa.0.0.extract.trunc.i = trunc i64 %0 to i32
  store i32 %__val.sroa.0.0.extract.trunc.i, ptr %__first.coerce, align 4, !tbaa !87
...
define i8 @"128"(ptr %0, ptr %opt_arg) {
bb:
...
define i64 @"130"(ptr %v, i32 %0, i64 %1, i64 %agg.tmp93.sroa.0.0.insert.ext, ptr %new_range.i.i, ptr %end_size_.i.i, ptr %agg.result, i64 %2) {
bb:
...
define i32 @"131"(ptr %call171, ptr %0, ptr %arrayidx.i546) {
bb:
...
define i64 @"132"(ptr %offsets, ptr %.omp.lb, i64 %0) {
bb:
  %1 = load ptr, ptr %offsets, align 8, !tbaa !8
...
define ptr @"134"(ptr %new_range.i.i457, ptr %0, ptr %el, i64 %sub.ptr.rhs.cast, i64 %1, ptr %end_size_.i) {
bb:
  %.pre.i.i476 = load ptr, ptr %new_range.i.i457, align 8, !tbaa !16
  %2 = load ptr, ptr %el, align 8, !tbaa !39
  %sub.ptr.lhs.cast = ptrtoint ptr %2 to i64
...
define ptr @"135"(ptr %_M_before_begin.i.i.i) {
bb:
...
define i64 @"138"(ptr %arrayidx.i208, i64 %0, i64 %1, i64 %2, i64 %3, i64 %xor.i211, i64 %4, i64 %5, i64 %xor4.i214, i64 %6, i64 %xor7.i217, ptr %num_nodes_, i64 %7, ptr %arrayidx.i72, i64 %xor.i75, i64 %xor4.i78, i64 %xor7.i81, i32 %8, ptr %el, ptr %.omp.lb) {
bb:
  ...
  %10 = load i64, ptr %num_nodes_, align 8, !tbaa !88
...
bb:
  %0 = load i64, ptr %_M_string_length.i.i.i, align 8, !tbaa !58, !noalias !89
...
define i32 @"144"(ptr %call171, ptr %arrayidx.i548, ptr %arrayidx.i549, ptr %arrayidx.i550, i64 %sub.ptr.rhs.cast.i.i.i.i552, i64 %0, i64 %1) {
bb:
  %2 = load i64, ptr %arrayidx.i550, align 8, !tbaa !0
  %add.ptr271 = getelementptr inbounds i32, ptr %call171, i64 %2
  %sub.ptr.lhs.cast.i.i.i.i551 = ptrtoint ptr %add.ptr271 to i64
...
define ptr @"148"(ptr %sample_counts, ptr %arrayidx.i, ptr %_M_bucket_count.i.i.i) {
bb:
  ...
  %2 = load ptr, ptr %sample_counts, align 8, !tbaa !92
  %arrayidx.i.i.i.i = getelementptr inbounds ptr, ptr %2, i64 %rem.i.i.i.i.i
  %3 = load ptr, ptr %arrayidx.i.i.i.i, align 8, !tbaa !16
  ret ptr %3
}

define i32 @"149"(ptr %__first, ptr %add.ptr.i.i.i.i, ptr %add.ptr2.i.i.i.i, i64 %sub1.i.i.i.i, i64 %mul.i.i.i.i) {
bb:
...
define i32 @"150"(ptr %n_start.0.in, i64 %0, i64 %1) {
bb:
  %n_start.0 = load ptr, ptr %n_start.0.in, align 8, !tbaa !16
  %incdec.ptr12.i.i.i.i = getelementptr inbounds i32, ptr %n_start.0, i64 %0
...
define ptr @"151"(ptr %__node, ptr %this, ptr %add.ptr.i, ptr %_M_bucket_count) {
bb:
...
define i64 @"153"(ptr %add.ptr.i113, ptr %cond.i31.i.i.i, i64 %0, ptr %count_vector, i64 %1, i64 %2, i64 %3) {
bb:
  %4 = load ptr, ptr %count_vector, align 8, !tbaa !16
...
define i64 @"154"(ptr %__begin0.sroa.0.060, i64 %0, ptr %_M_finish.i38, i64 %1) {
bb:
...
define i64 @"155"(ptr %__first.addr.033.i.i, ptr %el, i64 %0) {
bb:
  %agg.tmp.sroa.0.0.copyload.i.i.i = load i64, ptr %__first.addr.033.i.i, align 4
  %.pre = load ptr, ptr %el, align 8, !tbaa !39
  %incdec.ptr13.i.i.i.i = getelementptr inbounds %struct.EdgePair, ptr %.pre, i64 %0
...
define i8 @"156"(i8 %0, ptr %ref.tmp, ptr %__dnew.i.i.i) {
bb:
  %1 = load i64, ptr %__dnew.i.i.i, align 8, !tbaa !0, !noalias !82
  %2 = load ptr, ptr %ref.tmp, align 8, !tbaa !35, !alias.scope !82
  %arrayidx.i.i.i.i = getelementptr inbounds i8, ptr %2, i64 %1
  store i8 %0, ptr %arrayidx.i.i.i.i, align 1, !tbaa !22
  ret i8 %0
}

define i32 @"157"(ptr %__first, ptr %add.ptr.i, ptr %add.ptr2.i, i64 %sub1.i, i64 %mul.i, i64 %0, i64 %1) {
bb:
...
define i64 @"158"(ptr %arrayidx.i25, i64 %0, ptr %arrayidx.i23, ptr %el, ptr %.omp.lb) {
bb:
...
define i64 @"159"(ptr %offsets, ptr %num_nodes_.i, i64 %0) {
bb:
  %1 = load i64, ptr %num_nodes_.i, align 8, !tbaa !55
  %2 = and i64 %1, %0
...
define ptr @"164"(ptr %call.i, ptr %num_nodes_.i, ptr %end_size_.i) {
bb:
  %0 = load i64, ptr %num_nodes_.i, align 8, !tbaa !66
  %add.ptr.i = getelementptr inbounds i32, ptr %call.i, i64 %0
  store ptr %add.ptr.i, ptr %end_size_.i, align 8, !tbaa !4
  ret ptr %add.ptr.i
}

define i32 @"165"(ptr %_M_finish.i38, i64 %0, i64 %1) {
bb:
  %2 = load ptr, ptr %_M_finish.i38, align 8, !tbaa !37
  ...
  %3 = load i32, ptr %add.ptr.i.i, align 4, !tbaa !87
  ret i32 %3
}

define ptr @"166"(ptr %new_range.i.i, ptr %end_size_.i.i, ptr %agg.result, i64 %0) {
bb:
...
define i64 @"167"(ptr %.omp.lb, i64 %0, i64 %1, i64 %2, i64 %3, i64 %4, i64 %__i.018.i, i64 %add.i, i64 %inc.i, ptr %arrayidx7.i.1) {
bb:
  %5 = load i64, ptr %.omp.lb, align 8, !tbaa !0
  %add10 = add i64 %5, %0
  %rem.i.i.i = and i64 %add10, %1
...
define ptr @"168"(ptr %retval.0.i, ptr %add.ptr, i64 %__bkt_count) {
bb:
  %0 = load i32, ptr %add.ptr, align 4, !tbaa !10
  %conv.i.i.i = sext i32 %0 to i64
  %rem.i.i = urem i64 %conv.i.i.i, %__bkt_count
...
bb:
  ...
  %2 = load ptr, ptr %_M_ctype.i.i, align 8, !tbaa !94
  ret ptr %2
}

define i64 @"173"(ptr %call.i248, ptr %label_source_pair.sroa.5.0.call42.sroa_idx, i64 %0) {
bb:
  %label_source_pair.sroa.5.0.copyload = load i32, ptr %label_source_pair.sroa.5.0.call42.sroa_idx, align 4
  %conv45 = sext i32 %label_source_pair.sroa.5.0.copyload to i64
...
define ptr @"174"(ptr %_M_finish.i.i, i64 %0, i32 %1) {
bb:
...
define i32 @"175"(ptr %el, ptr %.omp.lb, i64 %0, i64 %1) {
bb:
  %2 = load i64, ptr %.omp.lb, align 8, !tbaa !0
  %3 = sub i64 %0, %2
  %n.vec = and i64 %3, %1
...
define i64 @"176"(i64 %local_total.038, ptr %arrayidx.i34, ptr %prefix, ptr %.omp.lb, i64 %0) {
bb:
  %1 = load i64, ptr %.omp.lb, align 8, !tbaa !0
  %mul13 = shl i64 %1, %0
  %2 = load ptr, ptr %prefix, align 8
...
define i32 @"177"(ptr %comp, ptr %arrayidx.i) {
bb:
  %arrayidx.i.promoted = load i32, ptr %arrayidx.i, align 4, !tbaa !10
...
define ptr @"178"(ptr %neighs, ptr %arrayidx.i, ptr %index, ptr %.omp.lb) {
bb:
  %0 = load ptr, ptr %neighs, align 8, !tbaa !16
  %1 = load i64, ptr %arrayidx.i, align 8, !tbaa !0
  %add.ptr = getelementptr inbounds i32, ptr %0, i64 %1
...
define i8 @"179"(ptr %arrayidx17.i.i, ptr %ref.tmp, i64 %conv5.i) {
bb:
  %0 = load ptr, ptr %ref.tmp, align 8, !tbaa !35, !alias.scope !101
  %arrayidx.i.i = getelementptr inbounds i8, ptr %0, i64 %conv5.i
  %1 = load i8, ptr %arrayidx17.i.i, align 2, !tbaa !22, !noalias !101
  store i8 %1, ptr %arrayidx.i.i, align 1, !tbaa !22
  ret i8 %1
}

define i64 @"180"(ptr %add.ptr.i113, ptr %_M_finish.i.i114, i64 %0) {
bb:
...
define ptr @"181"(ptr %cond.i31.i.i.i, ptr %_M_finish.i.i114, i64 %0, i64 %1, ptr %count_vector, i64 %2, i64 %3) {
bb:
  %4 = load ptr, ptr %_M_finish.i.i114, align 8, !tbaa !37
  %incdec.ptr.i.i = getelementptr inbounds %"struct.std::pair.18", ptr %4, i64 %0
...
define i32 @"182"(ptr %call171, ptr %arrayidx.i542, i64 %0, i64 %total_missing_inv.0649, ptr %arrayidx.i536) {
bb:
  %1 = load i64, ptr %arrayidx.i542, align 8, !tbaa !0
  %i200.0 = add nsw i64 %1, %0
  %2 = load i32, ptr %arrayidx.i536, align 4, !tbaa !10
...
define i64 @"183"(ptr %arrayidx.i535, i64 %total_missing_inv.0649, ptr %arrayidx.i536, ptr %offsets, i64 %indvars.iv691) {
bb:
  %.pre716.pre = load ptr, ptr %offsets, align 8, !tbaa !8
...
define ptr @"184"(ptr %new_range.i.i, ptr %el, i64 %0, i64 %1, ptr %end_capacity_.i.i.i) {
bb:
...
define ptr @"185"(ptr %this, i64 %__code, ptr %_M_bucket_count) {
bb:
  %0 = load i64, ptr %_M_bucket_count, align 8, !tbaa !93
...
define i32 @"186"(ptr %comp, ptr %arrayidx.i33, i32 %cond, ptr %arrayidx.i37) {
bb:
  %0 = load ptr, ptr %comp, align 8, !tbaa !7
  %p1.0 = load i32, ptr %arrayidx.i37, align 4, !tbaa !10
...
define ptr @"187"(ptr %__p.044, ptr %arrayidx) {
bb:
...
define i32 @"188"(ptr %0, ptr %1, ptr %2, ptr %_M_before_begin.i.i.i, i64 %3) {
bb:
  %call5.val.i.i.i = load i32, ptr %1, align 4, !tbaa !104
  %call.val.i.i.i = load i32, ptr %0, align 4, !tbaa !104
  ...
  %6 = load i32, ptr %second, align 4, !tbaa !104
  ret i32 %6
}

define i32 @"189"(ptr %end_size_.i, ptr %comp, i64 %0, i32 %1, ptr %_M_b.i.i) {
bb:
  ...
  %conv = add i32 %5, %1
  store i32 %conv, ptr %_M_b.i.i, align 4, !tbaa !106
  ret i32 %conv
}

define i32 @"190"(ptr %arrayidx212, ptr %call171, i64 %tail_index.0660, ptr %arrayidx.i542, ptr %arrayidx.i540, ptr %arrayidx.i541, i64 %0) {
bb:
  %1 = load i32, ptr %arrayidx212, align 4, !tbaa !10
  %.pre717 = load i32, ptr %arrayidx.i541, align 4, !tbaa !10
  %.pre731 = sext i32 %.pre717 to i64
...
define i32 @"191"(ptr %comp, i64 %conv4) {
bb:
  %.pre = load ptr, ptr %comp, align 8, !tbaa !7
...
define i32 @"192"(ptr %comp, i64 %conv4) {
bb:
  %0 = load ptr, ptr %comp, align 8, !tbaa !7
...
define <2 x i64> @"193"(ptr %0, <2 x i64> %1, <2 x i64> %2, ptr %.omp.lb, i64 %3, i64 %4, i64 %5, <2 x i64> %6, <2 x i64> %7, ptr %8, <2 x i64> %9, <2 x i64> %10, ptr %11) {
bb:
  %wide.load91 = load <2 x i64>, ptr %0, align 8, !tbaa !0
...
define <2 x i64> @"194"(ptr %0, ptr %offsets, ptr %num_nodes_.i, i64 %1, i64 %index770, i64 %2) {
bb:
  %wide.load = load <2 x i64>, ptr %0, align 8, !tbaa !0
  %3 = load ptr, ptr %offsets, align 8
  %4 = load i64, ptr %num_nodes_.i, align 8, !tbaa !55
...
define ptr @"195"(ptr %new_range.i.i, ptr %el, i64 %0, ptr %end_capacity_.i.i.i) {
bb:
  %1 = load ptr, ptr %new_range.i.i, align 8, !tbaa !16
  %2 = load ptr, ptr %el, align 8, !tbaa !39
  %sub.ptr.lhs.cast = ptrtoint ptr %2 to i64
...
define ptr @"196"(ptr %call.i4953, ptr %end_size_.i, ptr %degrees, i64 %0, i64 %1, ptr %end_size_.i51) {
bb:
  %2 = load ptr, ptr %degrees, align 8, !tbaa !7
...
define ptr @"197"(ptr %_M_before_begin.i, ptr %retval.0.i, ptr %add.ptr, i64 %__bkt_count) {
bb:
  %0 = load i32, ptr %add.ptr, align 4, !tbaa !10
  %conv.i.i.i = sext i32 %0 to i64
  %rem.i.i = urem i64 %conv.i.i.i, %__bkt_count
...
define ptr @"198"(ptr %new_range.i.i, ptr %el, i64 %0, i64 %1, ptr %end_capacity_.i.i.i) {
bb:
  %2 = load ptr, ptr %new_range.i.i, align 8, !tbaa !16
  %.pre = load ptr, ptr %el, align 8, !tbaa !39
  %incdec.ptr7.i.i = getelementptr inbounds %struct.EdgePair, ptr %.pre, i64 %0
...
define i64 @"199"(ptr %end_size_.i, ptr %this, i64 %0, i64 %1, ptr %.omp.ub) {
bb:
  %2 = load ptr, ptr %this, align 8, !tbaa !39
  %sub.ptr.rhs.cast.i = ptrtoint ptr %2 to i64
...
define i64 @"200"(i32 %shl19, ptr %arrayidx.i61, i64 %0, i64 %1, i64 %2, i64 %3, i64 %xor.i63, i64 %4, i64 %5, i64 %xor4.i, i64 %6, i64 %xor7.i, i32 %7, i32 %8, i32 %9, i32 %conv, i64 %10, i64 %ref.tmp30.sroa.0.0.insert.ext, ptr %el, ptr %.omp.lb) {
bb:
...
define ptr @"201"(ptr %out_index_.i, ptr %.omp.lb, i64 %0) {
bb:
  %1 = load i32, ptr %.omp.lb, align 4, !tbaa !10
  %2 = sext i32 %1 to i64
  %indvars.iv.next = add nsw i64 %2, %0
  %3 = load ptr, ptr %out_index_.i, align 8, !tbaa !108, !noalias !109, !llvm.access.group !112
  %arrayidx.i.i.i = getelementptr inbounds ptr, ptr %3, i64 %indvars.iv.next
  %4 = load ptr, ptr %arrayidx.i.i.i, align 8, !tbaa !16, !llvm.access.group !112
  ret ptr %4
}

define ptr @"202"(ptr %out_index_.i, ptr %it.sroa.0.0541, i32 %0) {
bb:
  %1 = load ptr, ptr %out_index_.i, align 8, !tbaa !108, !noalias !113
...
define i64 @"203"(ptr %arrayidx3.i, i64 %0, ptr %1, i64 %2, i64 %3, ptr %arrayidx7.i, i64 %4, i64 %5, ptr %arrayidx.i) {
bb:
...
define <2 x i64> @"205"(ptr %0, <2 x i64> %1, <2 x i64> %2, ptr %this, i64 %3, <2 x i64> %4, <2 x i64> %5, ptr %6, <2 x i64> %7, <2 x i64> %8, ptr %9) {
bb:
  %wide.load = load <2 x i64>, ptr %0, align 8, !tbaa !0
...
define i64 @"206"(ptr %_ZSt4cout, i64 %0) {
bb:
  %vtable.i = load ptr, ptr %_ZSt4cout, align 8, !tbaa !116
  %vbase.offset.ptr.i = getelementptr i8, ptr %vtable.i, i64 %0
  %vbase.offset.i = load i64, ptr %vbase.offset.ptr.i, align 8
  ret i64 %vbase.offset.i
}

define i64 @"207"(ptr %_M_element_count, i64 %0) {
bb:
  %1 = load i64, ptr %_M_element_count, align 8, !tbaa !118
  %inc = add i64 %1, %0
  store i64 %inc, ptr %_M_element_count, align 8, !tbaa !118
  ret i64 %inc
}

define i32 @"208"(i64 %indvars.iv687, ptr %incdec.ptr4.sink.i.i.i.i, ptr %__first.addr.015.i.i, ptr %neighs, ptr %arrayidx.i524, i64 %sub.ptr.rhs.cast.i.i.i.i526, i64 %0, i64 %1) {
bb:
...
define ptr @"210"(ptr %cond.i31.i.i.i, ptr %_M_finish.i38, i64 %0, i64 %1, i64 %2, i64 %3, i64 %4) {
bb:
...
define i32 @"211"(ptr %init_val, ptr %this, ptr %.omp.lb, i64 %0) {
bb:
  %1 = load ptr, ptr %this, align 8, !tbaa !7
  %2 = load i64, ptr %.omp.lb, align 8, !tbaa !0
  %add7 = add i64 %2, %0
...
define i32 @"212"(ptr %init_val, ptr %this, ptr %.omp.lb, i64 %0, i64 %1) {
bb:
...
define ptr @"213"(ptr %__p.044, ptr %_M_before_begin.i) {
bb:
...
define i64 @"214"(ptr %rng, i64 %0, ptr %_M_p.i.i.i, i64 %1) {
bb:
  %2 = load i64, ptr %_M_p.i.i.i, align 8, !tbaa !59
  %inc.i71 = add nuw nsw i64 %2, %1
...
define i32 @"215"(ptr %el, ptr %.omp.lb, i64 %0) {
bb:
  %1 = load i64, ptr %.omp.lb, align 8, !tbaa !0
  %add15 = add i64 %1, %0
  %2 = load ptr, ptr %el, align 8, !tbaa !39
...
define ptr @"216"(ptr %transpose, i8 %0, ptr %out_index_.i, ptr %in_index_.i, ptr %.omp.lb) {
bb:
...
define i64 @"217"(ptr %arrayidx.i.i, ptr %0, i64 %1, ptr %2) {
bb:
...
define i64 @"219"(ptr %offsets, ptr %num_nodes_.i, i64 %0) {
bb:
...
define i64 @"221"(ptr %arrayidx.i56.3, ptr %arrayidx.i56.2, ptr %arrayidx.i56.1, ptr %arrayidx.i56, i64 %total.074, ptr %call.i3943, ptr %num_blocks) {
bb:
  %0 = load i64, ptr %arrayidx.i56, align 8, !tbaa !0
  %add7 = add nsw i64 %0, %total.074
  %1 = load i64, ptr %arrayidx.i56.1, align 8, !tbaa !0
...
define ptr @"222"(ptr %_M_before_begin.i, ptr %this, i64 %__code, ptr %_M_bucket_count) {
bb:
...
define i32 @"223"(ptr %arrayidx.i35, ptr %comp, ptr %.omp.lb) {
bb:
  %0 = load i32, ptr %.omp.lb, align 4, !tbaa !10
  %1 = sext i32 %0 to i64
  %2 = load ptr, ptr %comp, align 8, !tbaa !7, !llvm.access.group !36
...
define i32 @"224"(ptr %degrees, i64 %mul12, i64 %umin, ptr %.omp.lb, i64 %indvar, i64 %0, i64 %n.mod.vf) {
bb:
  %1 = load i64, ptr %.omp.lb, align 8, !tbaa !0
  %2 = add i64 %1, %indvar
  %3 = shl i64 %2, %0
...
define i32 @"225"(ptr %add.ptr.i.i, ptr %__first, ptr %add.ptr.i, ptr %add.ptr2.i, i64 %sub1.i, i64 %mul.i) {
bb:
...
define i64 @"227"(ptr %_M_string_length.i.i.i, ptr %__dnew.i.i.i) {
bb:
  %0 = load i64, ptr %_M_string_length.i.i.i, align 8, !tbaa !58, !noalias !82
  store i64 %0, ptr %__dnew.i.i.i, align 8, !tbaa !0, !noalias !82
  ret i64 %0
}

define i32 @"228"(ptr %neighs, ptr %arrayidx.i523, ptr %arrayidx.i524, i64 %sub.ptr.rhs.cast.i.i.i.i526, i64 %0, i64 %1) {
bb:
...
define ptr @"229"(ptr %el, i64 %sub.ptr.rhs.cast, i64 %0, ptr %end_size_.i) {
bb:
  %1 = load ptr, ptr %el, align 8, !tbaa !39
  %sub.ptr.lhs.cast = ptrtoint ptr %1 to i64
  %sub.ptr.sub = sub i64 %sub.ptr.lhs.cast, %sub.ptr.rhs.cast
...
define i64 @"230"(ptr %this, i64 %0, ptr %arrayidx42.i, i64 %1, i64 %2, ptr %arrayidx49.i, i64 %3, i64 %4) {
bb:
...
define i64 @"231"(ptr %__first.addr.07.i.i.i.i.i.i.i, ptr %cond.i31.i.i.i, ptr %_M_finish.i38, i64 %0, i64 %1, i64 %2, i64 %3, i64 %4) {
bb:
...
define i64 @"232"(i64 %0, ptr %offsets, ptr %num_nodes_.i, i64 %1) {
bb:
  %2 = load ptr, ptr %offsets, align 8
  %3 = load i64, ptr %num_nodes_.i, align 8, !tbaa !55
...
define <2 x i64> @"233"(ptr %__first, <2 x i64> %0) {
bb:
...
define ptr @"234"(ptr %call.i134135, ptr %num_nodes, i64 %0, ptr %end_size_.i) {
bb:
  %1 = load i64, ptr %num_nodes, align 8, !tbaa !0
  %add = add nsw i64 %1, %0
...
define i64 @"235"(ptr %offsets, ptr %.omp.lb) {
bb:
...
define <2 x i64> @"236"(ptr %offsets, ptr %num_nodes_.i, i64 %0, i64 %index770, i64 %1) {
bb:
  %2 = load i64, ptr %num_nodes_.i, align 8, !tbaa !55
  %3 = and i64 %2, %0
...
define <4 x i32> @"237"(ptr %0, ptr %call171, ptr %arrayidx.i539, i64 %1, i64 %index800, i64 %2) {
bb:
  %wide.load803 = load <4 x i32>, ptr %0, align 4, !tbaa !10
...
define i32 @"238"(ptr %arrayidx.i.i.i60, ptr %n_start.0.in, i64 %0, ptr %diffs, ptr %.omp.lb) {
bb:
  %n_end.0 = load ptr, ptr %arrayidx.i.i.i60, align 8, !tbaa !16
...
define i32 @"239"(ptr %arrayidx.i7.i.i, i64 %.sroa.speculated.i.i) {
bb:
  %0 = load ptr, ptr %arrayidx.i7.i.i, align 8, !tbaa !16, !llvm.access.group !119
  %add.ptr.i = getelementptr inbounds i32, ptr %0, i64 %.sroa.speculated.i.i
  %1 = load i32, ptr %add.ptr.i, align 4, !tbaa !10, !llvm.access.group !119
  ret i32 %1
}

define i64 @"240"(ptr %arrayidx.i533, i64 %total_missing_inv.0649, ptr %arrayidx.i536, ptr %offsets, ptr %num_nodes_.i) {
bb:
  %0 = load i64, ptr %num_nodes_.i, align 8, !tbaa !55
  %.pre716.pre = load ptr, ptr %offsets, align 8, !tbaa !8
...
define i32 @"241"(ptr %comp, ptr %arrayidx.i33, i32 %cond, ptr %arrayidx.i37) {
bb:
  %.pre = load ptr, ptr %comp, align 8, !tbaa !7
  %p1.0 = load i32, ptr %arrayidx.i37, align 4, !tbaa !10
  %p2.048 = load i32, ptr %arrayidx.i33, align 4, !tbaa !10
...
define i64 @"242"(ptr %_M_b.i, ptr %__param, i64 %0, ptr %_M_b.i32) {
bb:
  %1 = load i64, ptr %__param, align 8, !tbaa !120
  %2 = load i64, ptr %_M_b.i, align 8, !tbaa !122
  %sub = sub i64 %2, %1
  %div31 = lshr i64 %sub, %0
  store i64 %div31, ptr %_M_b.i32, align 8, !tbaa !122
  ret i64 %div31
}

define i64 @"243"(ptr %__first, ptr %add.ptr.i.i.i, ptr %add.ptr2.i.i.i, ptr %v.i.i.i.i.i, ptr %v3.i.i.i.i.i, i64 %sub1.i.i.i, i64 %mul.i.i.i) {
bb:
...
define i64 @"244"(ptr %add.ptr3.i.i.i, ptr %__first, ptr %add.ptr.i.i.i, ptr %add.ptr2.i.i.i, ptr %v.i.i.i.i.i, ptr %v3.i.i.i.i.i, i64 %sub1.i.i.i, i64 %mul.i.i.i) {
bb:
  %0 = load i32, ptr %add.ptr.i.i.i, align 4, !tbaa !42
  %1 = load i32, ptr %add.ptr2.i.i.i, align 4, !tbaa !42
  %cmp7.i.i.i.i.i = icmp slt i32 %0, %1
...
define i64 @"245"(ptr %arrayidx.i56.3, ptr %arrayidx.i56.2, ptr %arrayidx.i56.1, ptr %arrayidx.i56, i64 %total.074, ptr %arrayidx.i55.epil) {
bb:
  %0 = load i64, ptr %arrayidx.i56, align 8, !tbaa !0
  %add7 = add nsw i64 %0, %total.074
  %1 = load i64, ptr %arrayidx.i56.1, align 8, !tbaa !0
...
define i8 @"246"(ptr %arrayidx.i17.i, ptr %ref.tmp, i64 %conv5.i, i64 %idxprom1.i.i) {
bb:
  %0 = load ptr, ptr %ref.tmp, align 8, !tbaa !35, !alias.scope !101
  %arrayidx.i.i = getelementptr inbounds i8, ptr %0, i64 %conv5.i
  %arrayidx2.i.i = getelementptr inbounds i8, ptr %arrayidx.i.i, i64 %idxprom1.i.i
  %1 = load i8, ptr %arrayidx.i17.i, align 1, !tbaa !22, !noalias !101
  store i8 %1, ptr %arrayidx2.i.i, align 1, !tbaa !22
  ret i8 %1
}

define i64 @"247"(ptr %el, i64 %0) {
bb:
  %.pre = load ptr, ptr %el, align 8, !tbaa !39
  %incdec.ptr13.i.i.i.i = getelementptr inbounds %struct.EdgePair, ptr %.pre, i64 %0
...
define ptr @"249"(ptr %el, ptr %0, i64 %sub.ptr.rhs.cast, i64 %1, ptr %end_size_.i) {
bb:
  %.pre = load ptr, ptr %el, align 8, !tbaa !39
  %2 = load ptr, ptr %el, align 8, !tbaa !39
  %sub.ptr.lhs.cast = ptrtoint ptr %2 to i64
...
define i32 @"250"(ptr %comp, ptr %arrayidx.i36.phi.trans.insert) {
bb:
  %0 = load ptr, ptr %comp, align 8, !tbaa !7
  %.pre52 = load i32, ptr %arrayidx.i36.phi.trans.insert, align 4, !tbaa !10
  %conv13 = sext i32 %.pre52 to i64
...
!72 = !{!30, !6, i64 0}
!73 = !{!74}
!74 = distinct !{!74, !75, !"_ZSt19__relocate_object_aISt4pairIiiES1_SaIS1_EEvPT_PT0_RT1_: %__orig"}
!75 = distinct !{!75, !"_ZSt19__relocate_object_aISt4pairIiiES1_SaIS1_EEvPT_PT0_RT1_"}
!76 = !{!77}
!77 = distinct !{!77, !75, !"_ZSt19__relocate_object_aISt4pairIiiES1_SaIS1_EEvPT_PT0_RT1_: %__dest"}
!78 = !{!34, !6, i64 8}
!79 = !{!34, !6, i64 16}
!80 = !{!81, !11, i64 4}
...
!93 = !{!50, !1, i64 8}
!94 = !{!95, !6, i64 240}
!95 = !{!"_ZTSSt9basic_iosIcSt11char_traitsIcEE", !96, i64 0, !6, i64 216, !2, i64 224, !13, i64 225, !6, i64 232, !6, i64 240, !6, i64 248, !6, i64 256}
!96 = !{!"_ZTSSt8ios_base", !1, i64 8, !1, i64 16, !97, i64 24, !98, i64 28, !98, i64 32, !6, i64 40, !99, i64 48, !2, i64 64, !11, i64 192, !6, i64 200, !100, i64 208}
!97 = !{!"_ZTSSt13_Ios_Fmtflags", !2, i64 0}
!98 = !{!"_ZTSSt12_Ios_Iostate", !2, i64 0}
!99 = !{!"_ZTSNSt8ios_base6_WordsE", !6, i64 0, !1, i64 8}
!100 = !{!"_ZTSSt6locale", !6, i64 0}
!101 = !{!102}
!102 = distinct !{!102, !103, !"_ZNSt7__cxx119to_stringEi: %agg.result"}
!103 = distinct !{!103, !"_ZNSt7__cxx119to_stringEi"}
!104 = !{!105, !11, i64 4}
!105 = !{!"_ZTSSt4pairIKiiE", !11, i64 0, !11, i64 4}
!106 = !{!107, !11, i64 4}
!107 = !{!"_ZTSNSt24uniform_int_distributionIiE10param_typeE", !11, i64 0, !11, i64 4}
!108 = !{!67, !6, i64 24}
!109 = !{!110}
!110 = distinct !{!110, !111, !"_ZNK8CSRGraphIiiLb1EE9out_neighEim: %agg.result"}
!111 = distinct !{!111, !"_ZNK8CSRGraphIiiLb1EE9out_neighEim"}
!112 = distinct !{}
!113 = !{!114}
!114 = distinct !{!114, !115, !"_ZNK8CSRGraphIiiLb1EE9out_neighEim: %agg.result"}
!115 = distinct !{!115, !"_ZNK8CSRGraphIiiLb1EE9out_neighEim"}
!116 = !{!117, !117, i64 0}
!117 = !{!"vtable pointer", !3, i64 0}
!118 = !{!50, !1, i64 24}
!119 = distinct !{}
!120 = !{!121, !1, i64 0}
!121 = !{!"_ZTSNSt24uniform_int_distributionImE10param_typeE", !1, i64 0, !1, i64 8}
!122 = !{!121, !1, i64 8}
