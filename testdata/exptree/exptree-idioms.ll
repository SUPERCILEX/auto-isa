...
define i32 @"0"(ptr %arrayidx32, ptr %operand29.i, ptr %workList, ptr %listLength, i32 %searchDepth) {
bb:
  ...
  %2 = load i32, ptr %arrayidx32, align 4, !tbaa !4
  %3 = load i32, ptr %operand29.i, align 4, !tbaa !6
  %div.i = sdiv i32 %2, %3
  store i32 %div.i, ptr %arrayidx75, align 4, !tbaa !4
  ret i32 %div.i
}

define i32 @"1"(ptr %arrayidx, ptr %arrayidx2) {
bb:
...
define i32 @"2"(ptr %workList, i32 %add, ptr %listLength) {
bb:
  %0 = load ptr, ptr %workList, align 8, !tbaa !0
  %1 = load i32, ptr %listLength, align 4, !tbaa !4
  %sub = add i32 %add, %1
...
define i32 @"5"(ptr %operand2.i134, i32 %working1.0, ptr %workList, ptr %listLength, i32 %searchDepth) {
bb:
  %0 = load ptr, ptr %workList, align 8, !tbaa !0
  %1 = load i32, ptr %listLength, align 4, !tbaa !4
  %add73 = add nsw i32 %1, %searchDepth
...
define i32 @"6"(ptr %nbNodes, i32 %0) {
bb:
...
define i32 @"7"(ptr %combList, i64 %indvars.iv.i) {
bb:
  %0 = load ptr, ptr %combList, align 8, !tbaa !0
...
define i32 @"8"(i32 %working1.0, ptr %operand23.i, ptr %workList, ptr %listLength, i32 %searchDepth) {
bb:
  %0 = load ptr, ptr %workList, align 8, !tbaa !0
  %1 = load i32, ptr %listLength, align 4, !tbaa !4
  %add73 = add nsw i32 %1, %searchDepth
...
define i32 @"9"(ptr %operand26.i, i32 %working1.0, ptr %workList, ptr %listLength, i32 %searchDepth) {
bb:
  %0 = load ptr, ptr %workList, align 8, !tbaa !0
  %1 = load i32, ptr %listLength, align 4, !tbaa !4
  %add73 = add nsw i32 %1, %searchDepth
